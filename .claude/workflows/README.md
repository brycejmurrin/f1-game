...
| `test-semantics-audit.js` | Reads every test file in full → per-file semantic verdicts → group taxonomy + tests/ split map + change-aware CI design → feasibility skeptic. Produced `docs/research/TEST-AUDIT-2026-08.md`. | Yes — re-run after big suite changes. |
