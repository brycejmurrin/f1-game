...
`spineLogo` (SPINE TOP: `logo|none|saddle|panel|stripe|twin|wordmark|carbon|number`,
...
offer `plate|wordmark|slash` (from the 2026 launch photos). `drawTailGraphic` clips to its region. Body details:
