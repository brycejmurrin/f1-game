...
node tools/shot/garage-angles.mjs --list-ids       # spine-logo, spine-side, view groups
...
- Parameterized garage camera surveys (views, spine, parts, live rollup) → [references/garage-angles.md](references/garage-angles.md).
