...
web). The test suite is 112 Playwright specs + 108 `node --test` unit suites. Unified entry: `tools/probe-mcp.py` (`chrome_*` / `tinyfish_*`).
...
Wrap map: `docs/AGENT-SURFACE.md` (apex-tools vs this skill vs TinyFish).
