...
The project ships a **Playwright test suite** — 111 Playwright specs — plus
65 `node --test` unit suites, covering physics regression, AI behaviour, geometry audits, UI
