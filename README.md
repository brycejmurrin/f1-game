...
The project ships a **Playwright test suite** — 122 Playwright specs — plus
300+ `node --test` unit suites, covering rendering, physics, UI across screens,
...
node tools/track/verify-track.cjs --all            # headless build check, all 52 circuits (no browser)
```
