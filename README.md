...
The project ships a **Playwright test suite** — 112 Playwright specs — plus
90 `node --test` unit suites, covering physics regression, AI behaviour, geometry audits, UI
