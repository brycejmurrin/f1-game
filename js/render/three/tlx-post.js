 ...
 *                    pass into level 0 OVERWRITES (glx/post.js:565-578)
...
(function () {
  ...
  function postChain(THREE, TSL, ctx) {
    ...
    function present(opts, F) {
      ...
      // ── 0) SSAO + separable blur (glx/post.js:393-431). Runs when EITHER
      ...
      // ── 0b) Volumetric sun shafts + lamp beams (glx/post.js:435-527) ─────
      ...
      if (haveGR) {
        ...
        if (lampVol > 0 && L) {
          ...
          for (let i = 0; i < grNL; i++) {
            ...
            // in THIS pass's nearest-N ordering (glx/post.js:474-477).
      ...
      // ── 1+2) bright pass + mip-chain bloom (glx/post.js:529-581) ──────────
      ...
      // ── 3) composite (glx/post.js:583-753) ────────────────────────────────
      ...
      // flare curve (glx/post.js:612-641 verbatim).
