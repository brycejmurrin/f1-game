...
(function () {
  ...
  function post(THREE, TSL, ctx) {
    ...
    // Default ON when PerfTry is absent (standalone TSL harness).
    const flareGate = typeof PerfTry === "undefined" || PerfTry.on("flareGate");
    ...
    const composite = {
      ...
      mat: passMaterial(Fn(() => {
        ...
        // PerfTry.flareGate: skip the depth fetch when the flare is off or the
        // sun is off-screen (uniform CF). OFF keeps the ungated fetch.
