  ...
  const CATALOG = [
    {
      ...
      options: [
        ...
        { id: "lean_burn",    label: "Lean Burn",      cost:  30, desc: "Efficiency-tuned mapping — fuel saving with surprising torque",     accel: 1.05 },
        { id: "performance",  label: "Performance",    cost:  60, desc: "Optimised mapping — peak acceleration gains",                       speed: 1.00, accel: 1.09 },
        { id: "v_power",      label: "V-Power Spec",   cost:  70, desc: "Premium fuel-optimised mapping — balanced speed and accel",        speed: 1.02, accel: 1.07 },
        ...
        { id: "evo_kit",      label: "EVO Kit",        cost: 120, desc: "Engine evolution package — well-rounded gains across all metrics", speed: 1.04, accel: 1.07, cornering: 1.02 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "s_duct",        label: "S-Duct",         cost:  60, desc: "Shaped duct package — front aero efficiency with grip trade-off", speed: 1.04, cornering: 0.93 },
        { id: "medium",        label: "Medium",         cost:   0, desc: "Balanced configuration for all circuit types",                   speed: 1.00, cornering: 1.00 },
        { id: "beam_wing",     label: "Beam Wing",      cost:  50, desc: "Rear beam wing — cornering and braking from low-drag base",      speed: 0.99, cornering: 1.07, braking: 1.04 },
        ...
        { id: "underfloor",    label: "Underfloor Kit", cost: 120, desc: "Enhanced tunnel floors — high grip with less drag penalty",      speed: 0.94, cornering: 1.22 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "triple_damper",   label: "Triple Damper",   cost: 100, desc: "Three-stage damper system — precise compliance across all corner phases", cornering: 1.17, speed: 1.01 },
        { id: "titanium_spring", label: "Titanium Spring", cost: 110, desc: "Ultra-light titanium coils — mass reduction with stiffer cornering",     cornering: 1.19, accel: 1.02 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "drilled",     label: "Drilled Steel",    cost:  30, desc: "Cross-drilled steel discs — improved heat management",                      braking: 1.05 },
        ...
        { id: "dual_caliper",label: "Dual Caliper",     cost:  80, desc: "Twin-piston caliper setup — stronger bite with improved exit traction",     braking: 1.13, accel: 1.02 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "slick_track",  label: "Slick Track",   cost:  40, desc: "Pure dry-weather slick — optimised compound structure",                       speed: 1.01, cornering: 1.04, accel: 1.01 },
        ...
        { id: "p_zero_red",   label: "P Zero Red",    cost: 160, desc: "Custom Pirelli high-performance compound — between Super Soft and Quali",     speed: 0.92, cornering: 1.24, accel: 1.07 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "split_deploy",   label: "Split Deploy",  cost:  90, desc: "Per-axle deployment control — improved cornering traction and accel",        accel: 1.06, cornering: 1.04 },
        ...
        { id: "thermal_max",    label: "Thermal Max",   cost: 110, desc: "Heat energy recovery focus — speed gains with consistent braking",           speed: 1.04, braking: 1.03 },
    ...
    },
    {
      ...
      options: [
        { id: "standard",      label: "Standard",       cost:   0, desc: "Factory sequential 8-speed — baseline shift performance",                    speed: 1.00, accel: 1.00 },
        { id: "close_ratio",   label: "Close Ratio",    cost:  50, desc: "Tighter gear spacing — stronger drive out of slow corners",                  accel: 1.06, speed: 0.98 },
        { id: "long_ratio",    label: "Long Ratio",     cost:  40, desc: "Wider gear spacing — improved top speed on power circuits",                  speed: 1.04, accel: 0.97 },
        { id: "short_stack",   label: "Short Stack",    cost:  70, desc: "Extra-short first gear — explosive launch and corner exit traction",         accel: 1.08, cornering: 1.03 },
        { id: "sequential_pro",label: "Sequential Pro", cost:  90, desc: "Faster shift times — reduced power interruption through the rev range",      accel: 1.07, speed: 1.02 },
        { id: "carbon_case",   label: "Carbon Case",    cost: 130, desc: "Lightweight carbon housing — mass reduction improves accel and handling",     accel: 1.08, speed: 1.02, cornering: 1.02 },
        { id: "f1_spec",       label: "F1 Spec",        cost: 180, desc: "Race-validated paddle-shift unit — peak response and powerflow efficiency",   speed: 1.04, accel: 1.10, cornering: 1.03 },
      ],
    },
    {
      id: "fuel", label: "FUEL",
      options: [
        { id: "standard",      label: "Standard",       cost:   0, desc: "Baseline pump-spec fuel — meets FIA minimum grade",                          speed: 1.00, accel: 1.00 },
        { id: "high_octane",   label: "High Octane",    cost:  40, desc: "Higher octane blend — cleaner combustion and accel improvement",             accel: 1.05 },
        { id: "biofuel",       label: "Biofuel 100",    cost:  50, desc: "FIA-sustainable 100% biofuel — consistent burn and slight braking gain",     braking: 1.04, accel: 1.03 },
        { id: "race_blend",    label: "Race Blend",     cost:  90, desc: "F1-regulation compound — refined energy density for speed and accel",        speed: 1.02, accel: 1.06 },
        { id: "quali_mix",     label: "Qualifying Mix", cost: 150, desc: "Maximum energy density — qualifying-spec fuel load for peak performance",    speed: 1.04, accel: 1.08 },
        { id: "custom_formula",label: "Custom Formula", cost: 200, desc: "Team-developed proprietary blend — marginal all-metric gains",               speed: 1.05, accel: 1.09, cornering: 1.02, braking: 1.02 },
      ],
    },
  ];
