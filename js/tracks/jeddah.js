...
(function () {
  ...
  (window.TrackDefs = window.TrackDefs || []).push(
  {
    ...
    baseHW: 6,
    pal: {
      zenith:        [0.10, 0.10, 0.28],
      horizon:       [0.58, 0.30, 0.08],
      sun:           [1.0,  0.75, 0.35],
      sunColor:      [0.98, 0.78, 0.42],
      ambientSky:    [0.38, 0.28, 0.18],
      ambientGround: [0.22, 0.16, 0.10],
      fogColor:      [0.46, 0.26, 0.12],
      fogDensity:    0.0019,
      concrete:      [0.28, 0.27, 0.26],
      runoff:        [0.25, 0.24, 0.22],
      grass:         [0.20, 0.18, 0.14],
      sunDir:        [0.55, 0.35, 0.25],
    },
    segs: [
