...
(function () {
  ...
  (window.TrackDefs = window.TrackDefs || []).push(
  {
    ...
    baseHW: 8,
    pal: {
      zenith:        [0.06, 0.05, 0.18],
      horizon:       [0.52, 0.22, 0.10],
      sun:           [0.98, 0.60, 0.28],
      sunColor:      [0.92, 0.62, 0.32],
      ambientSky:    [0.34, 0.24, 0.18],
      ambientGround: [0.24, 0.16, 0.10],
      fogColor:      [0.40, 0.20, 0.10],
      fogDensity:    0.0022,
      concrete:      [0.26, 0.25, 0.24],
      runoff:        [0.22, 0.21, 0.20],
      grass:         [0.18, 0.16, 0.12],
      sunDir:        [0.5, 0.28, 0.3],
    },
    segs: [
