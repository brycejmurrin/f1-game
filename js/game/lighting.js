...
const TUNE_DEFS = [
  ...
  { id: "pcssPen",      label: "SHADOW SOFTEN",   group: "SHADOWS", min: 5, max: 200, step: 5, def: 80, u: "uPcssPen", help: "How fast shadows soften with caster distance (PCSS penumbra growth). Live on WebGL2, WebGPU, three.js WebGPU, and three.js desktop WebGL2 (R16F depth-in-color blocker). Phones and software GL on three.js keep a fixed-radius kernel — this slider does nothing on that path only." },
