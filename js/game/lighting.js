...
const TUNE_DEFS = [
  ...
  { id: "pcssPen",      label: "SHADOW SOFTEN",   group: "SHADOWS", min: 5, max: 200, step: 5, def: 80, u: "uPcssPen", help: "How fast shadows soften with caster distance (PCSS penumbra growth). Live on WebGL2, WebGPU, and three.js WebGPU (real blocker search). three.js WebGL2 keeps a fixed-radius kernel — this slider does nothing on that path only." },
