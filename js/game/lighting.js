...
const TUNE_DEFS = [
  ...
  { id: "lampLevel",    label: "LAMP LEVEL",      group: "LAMPS", section: "POOLS", min: 0, max: 4.5, step: 0.001, def: 0.26, help: "Overall lamp brightness ceiling (on top of the twilight ramp). Applies to every track lamp — street posts and flood banks alike. 0 = fully off." },
