...
const TUNE_DEFS = [
  ...
  { id: "poolEnergy",   label: "POOL ENERGY",     group: "LAMPS", section: "POOLS", min: 0, max: 6, step: 0.001, def: 0.55, rebuild: true, help: "Per-lamp pool luminance scale (physical energy per fixture). Takes effect on the next track rebuild. 0 = no pool." },
  ...
  { id: "glowAmp",      label: "EMISSIVE GLOW",   group: "NIGHT GLOW & BLOOM", min: 0, max: 9, step: 0.005,   def: 2.3,  u: "uGlowAmp", help: "HDR push for windows / lenses / neon — roughly half the night frame energy. 0 = fully off." },
