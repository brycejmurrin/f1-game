...
const TUNE_DEFS = [
  ...
  { id: "bloomSpread",  label: "BLOOM SPREAD",    group: "NIGHT GLOW & BLOOM", min: 0.25, max: 2.125, step: 0.001, def: 1.0, u: "uSpread", help: "Halo WIDTH, independent of amount. Higher = wider, dreamier glow; lower = tight core. Stays live on GRAPHICS: LOW." },
  { id: "threshOff",    label: "BLOOM THRESHOLD", group: "NIGHT GLOW & BLOOM", min: -0.5, max: 0.4, step: 0.0025,  def: 0.0,  help: "Offset on what counts as bright enough to bloom. Lower = mid-tones glow (fog-of-glow). The composite is `clamp(base + this, 0.4, 1.2)` — night bases sit near 0.97 so the last +0.4 notch is already at the 1.2 ceiling; day bases sit near 0.78 so the last −0.5 notch is already at the 0.4 floor. Stays live on GRAPHICS: LOW." },
  ...
  { id: "lampVolBase",  label: "BEAMS (CLEAR)",   group: "ATMOSPHERE", min: 0, max: 0.9, step: 0.001, def: 0.05, help: "Volumetric lamp-beam strength in clear night air. Stays live on GRAPHICS: LOW (desktop). Mobile tier renders no beams regardless (the volumetric pass is shed for GPU headroom)." },
  ...
  // ── REFLECTIONS ──
  { id: "ssrWetMul",    label: "WET MIRROR",      group: "ROAD & REFLECTIONS", min: 0, max: 2.5, step: 0.01, def: 1.0,  help: "Wet-road scene-mirror strength (scales the wetness ramp). Off on GRAPHICS: LOW and MEDIUM (SSR cost shed)." },
  ...
  // ── CAR ──
  { id: "carReflect",   label: "CAR REFLECTION",  group: "CAR", min: 0, max: 1.5, step: 0.005, def: 0.05, u: "uCarReflect", help: "How strongly the world (track, sky, lights) mirrors on the car bodywork. Off on GRAPHICS: LOW and MEDIUM (SSR cost shed)." },
