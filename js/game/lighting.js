...
// every ~22 m (alternating sides) at mast height, capped to the 48 shader slots
...
const TUNE_DEFS = [
  ...
  { id: "lampVolBase",  label: "BEAMS (CLEAR)",   group: "ATMOSPHERE", min: 0, max: 0.9, step: 0.001, def: 0.05, help: "Volumetric lamp-beam strength in clear night air. Mobile tier renders no beams regardless (the volumetric pass is shed for GPU headroom)." },
