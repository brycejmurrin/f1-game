...
const TUNE_DEFS = [
  ...
  { id: "carGloss",     label: "PAINT GLOSS",     group: "CAR", min: 0.15, max: 1.4, step: 0.005, def: 1.0,  u: "uCarGloss", help: "Sharpness of the paint's highlights & reflections. Higher = glassier (lower roughness). Ceiling is 1.4 — `carSoft = clamp((1.4 - gloss)*0.5, 0, 1)` in the SSR streak is already 0 there, so anything higher was dead travel. Floor 0.15 is where typical paint roughness (`base/gloss`) hits the 1.0 clamp." },
