...
const apexCams = ApexCameras.create(G);
...
const api = {
  ...
  // Debug free-cam shots — bodies live in ApexCameras (js/game/apex-cameras.js).
  view: (...a) => apexCams.view(...a),
  eyeAt: (...a) => apexCams.eyeAt(...a),
  orbit: (...a) => apexCams.orbit(...a),
  cinematic: (...a) => apexCams.cinematic(...a),
  studio: (...a) => apexCams.studio(...a),
  carOrbit: (...a) => apexCams.carOrbit(...a),
  dolly: (...a) => apexCams.dolly(...a),
  roadside: (...a) => apexCams.roadside(...a),
  tourShots: (...a) => apexCams.tourShots(...a),
