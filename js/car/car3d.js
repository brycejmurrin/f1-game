...
const Car3D = (function () {
  ...
  // Foil thickness/camber + the active-aero solver live on Car3DFlaps
  // (loaded first). addWingFoil and build() call through these aliases.
  const { FOIL_CAMBER, foilThick, endplateGeom, frontCascade, frontBakedCount,
          frontHalf, aeroFlapsGeom, aeroFlapAim, numberBoard } = Car3DFlaps;
