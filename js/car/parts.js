...
const Parts = (function () {
  ...
  const FACTORY_PRESETS = {
    mercedes:    { engine: "sig_mercedes_zero", aero: "sig_mercedes_wing", suspension: "sig_mercedes_susp", brakes: "sig_mercedes_discs", tyres: "sig_mercedes_tyre", ers: "sig_mercedes_ers", gearbox: "sig_mercedes_gbox", fuel: "sig_mercedes_fuel", exhaust: "sig_mercedes_exh", floor: "sig_mercedes_floor" },
    ferrari:     { engine: "manu_ferrari", aero: "sig_ferrari_wing", suspension: "sig_ferrari_susp", brakes: "sig_ferrari_brembo", tyres: "sig_ferrari_tyre", ers: "sig_ferrari_ers", gearbox: "sig_ferrari_seamless", fuel: "sig_ferrari_fuel", exhaust: "sig_ferrari_exh", floor: "sig_ferrari_floor" },
    mclaren:     { engine: "sig_mclaren_pu", aero: "sig_mclaren_flex", suspension: "sig_mclaren_active", brakes: "sig_mclaren_brakes", tyres: "sig_mclaren_tyre", ers: "sig_mclaren_ers", gearbox: "sig_mclaren_gbox", fuel: "sig_mclaren_fuel", exhaust: "sig_mclaren_exh", floor: "sig_mclaren_floor" },
    redbull:     { engine: "manu_ford", aero: "sig_redbull_concept", suspension: "sig_redbull_pullrod", brakes: "sig_redbull_brakes", tyres: "sig_redbull_tyre", ers: "sig_redbull_ers", gearbox: "sig_redbull_gbox", fuel: "sig_redbull_fuel", exhaust: "sig_redbull_exh", floor: "sig_redbull_floor" },
    alpine:      { engine: "sig_alpine_pu", aero: "sig_alpine_wing", suspension: "sig_alpine_susp", brakes: "sig_alpine_brakes", tyres: "sig_alpine_tyre", ers: "sig_alpine_boost", gearbox: "sig_alpine_gbox", fuel: "sig_alpine_efuel", exhaust: "sig_alpine_exh", floor: "sig_alpine_floor" },
    racingbulls: { engine: "sig_racingbulls_pu", aero: "sig_racingbulls_wing", suspension: "sig_racingbulls_susp", brakes: "sig_racingbulls_brakes", tyres: "sig_rb_street", ers: "sig_racingbulls_ers", gearbox: "sig_rb_shortcase", fuel: "sig_racingbulls_fuel", exhaust: "sig_racingbulls_exh", floor: "sig_racingbulls_floor" },
    haas:        { engine: "sig_haas_pu", aero: "sig_haas_wing", suspension: "sig_haas_susp", brakes: "sig_haas_carbonmag", tyres: "sig_haas_tyre", ers: "sig_haas_ers", gearbox: "sig_haas_gbox", fuel: "sig_haas_blend", exhaust: "sig_haas_exh", floor: "sig_haas_floor" },
    williams:    { engine: "sig_williams_pu", aero: "sig_williams_lowdrag", suspension: "sig_williams_susp", brakes: "sig_williams_brakes", tyres: "sig_williams_tyre", ers: "sig_williams_ers", gearbox: "sig_williams_longshift", fuel: "sig_williams_fuel", exhaust: "sig_williams_exh", floor: "sig_williams_floor" },
    audi:        { engine: "manu_audi", aero: "sig_audi_wing", suspension: "sig_audi_damper", brakes: "sig_audi_brakes", tyres: "sig_audi_tyre", ers: "sig_audi_quattro", gearbox: "sig_audi_gbox", fuel: "sig_audi_fuel", exhaust: "sig_audi_exh", floor: "sig_audi_floor" },
    astonmartin: { engine: "manu_honda", aero: "sig_aston_tunnel", suspension: "sig_astonmartin_susp", brakes: "sig_aston_carbon", tyres: "sig_astonmartin_tyre", ers: "sig_astonmartin_ers", gearbox: "sig_astonmartin_gbox", fuel: "sig_astonmartin_fuel", exhaust: "sig_astonmartin_exh", floor: "sig_astonmartin_floor" },
    cadillac:    { engine: "sig_cadillac_pu", aero: "sig_cadillac_lowline", suspension: "sig_cadillac_susp", brakes: "sig_cadillac_brakes", tyres: "sig_cadillac_sprint", ers: "sig_cadillac_ers", gearbox: "sig_cadillac_gbox", fuel: "sig_cadillac_fuel", exhaust: "sig_cadillac_exh", floor: "sig_cadillac_floor" },
  };
