  ...
  const CATALOG = [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "wet_full",     label: "Full Wet",      cost:   0, desc: "Deep-tread monsoon tyre — the only compound that clears standing water",         speed: 0.88, cornering: 0.90, accel: 0.90, visual: { band: [0.10, 0.40, 0.92], grooved: true, grooves: 4, grooveDepth: 0.075, bandWidth: 0.09, coverVanes: 4, shoulder: 2 }, visualTier: 0 },
        ...
        { id: "branded_wall", label: "Branded Wall", cost: 30, desc: "Double raised lettering rings on the sidewall — the promoter's compound, medium underneath", cornering: 1.02, visual: { sidewall: 2, band: [0.94, 0.94, 0.96], grooved: false, grooves: 0, bandWidth: 0.06, coverVanes: 6, shoulder: 0 }, visualTier: 1 },
