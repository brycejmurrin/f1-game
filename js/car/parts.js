    ...
    },
    {
      ...
      options: [
        ...
        { id: "sig_ferrari_cpit", label: "Maranello Cockpit", cost: 160, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "full_shroud",
          desc: "Ferrari signature cockpit — Full Shroud performance with a fully faired halo and an upper flap", speed: 1.01, cornering: 1.08, braking: 1.02, visual: { haloBlade: 2, haloWing: 1, camPods: 0, screen: 1 }, visualTier: 2 },
        ...
        { id: "sig_redbull_cpit", label: "Milton Keynes Cockpit", cost: 60, teams: ["redbull"], tag: "SIGNATURE", equivalent: "deflector",
          desc: "Red Bull signature cockpit — Deflector performance with a fully faired halo", speed: 1.03, braking: 1.02, visual: { haloBlade: 0, haloWing: 1, camPods: 1, screen: 0 }, visualTier: 2 },
        { id: "sig_alpine_cpit", label: "Enstone Cockpit", cost: 40, teams: ["alpine"], tag: "SIGNATURE", equivalent: "faired_halo",
          desc: "Alpine signature cockpit — Faired Halo performance with a bladed halo and an upper flap", speed: 1.02, visual: { haloBlade: 1, haloWing: 1, camPods: 0, screen: 0 }, visualTier: 1 },
        ...
        { id: "sig_haas_cpit", label: "Kannapolis Cockpit", cost: 0, teams: ["haas"], tag: "SIGNATURE", equivalent: "standard",
          desc: "Haas signature cockpit — Standard performance with a bare halo", visual: { haloBlade: 0, haloWing: 1, camPods: 0, screen: 0 }, visualTier: 1 },
        { id: "sig_williams_cpit", label: "Grove Cockpit", cost: 40, teams: ["williams"], tag: "SIGNATURE", equivalent: "faired_halo",
          desc: "Williams signature cockpit — Faired Halo performance with a bare halo", speed: 1.02, visual: { haloBlade: 1, haloWing: 0, camPods: 2, screen: 1 }, visualTier: 1 },
        { id: "sig_audi_cpit", label: "Neuburg Cockpit", cost: 60, teams: ["audi"], tag: "SIGNATURE", equivalent: "deflector",
          desc: "Audi signature cockpit — Deflector performance with a fully faired halo and an upper flap", speed: 1.03, braking: 1.02, visual: { haloBlade: 2, haloWing: 0, camPods: 1, screen: 1 }, visualTier: 2 },
        { id: "sig_astonmartin_cpit", label: "Silverstone Cockpit", cost: 160, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "full_shroud",
          desc: "Aston Martin signature cockpit — Full Shroud performance with a fully faired halo and an upper flap", speed: 1.01, cornering: 1.08, braking: 1.02, visual: { haloBlade: 2, haloWing: 1, camPods: 1, screen: 1 }, visualTier: 2 },
