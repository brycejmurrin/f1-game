...
const Parts = (function () {
  ...
  const CATALOG = [
    ...
    },
    {
      id: "aero", label: "AERO",
      options: [
        { id: "minimal",       label: "Minimal",        cost:   0, desc: "+10% top speed — heavily reduced downforce",                     speed: 1.10, cornering: 0.78, visual: {lvl: 0, vane: 0, frontSweep: -0.03, frontTaper: 1.05, frontRise: 0, rearSweep: -0.02, rearTaper: 1.04, floorEdge: 0.78, floorCut: 0.02, diffuserRise: 0.72, fin: 0.6}, visualTier: 0 },
        { id: "le_mans",       label: "Le Mans Trim",   cost:  80, desc: "Hypercar ultra-low drag — extreme top speed, severe grip penalty", speed: 1.14, cornering: 0.80, visual: {lvl: 0, vane: 1, frontSweep: 0.01, frontTaper: 0.94, frontRise: 0.01, rearSweep: 0.02, rearTaper: 0.9, floorEdge: 0.82, floorCut: 0.08, diffuserRise: 0.76, fin: 0.72}, visualTier: 0 },
        { id: "low",           label: "Low DF",         cost:  40, desc: "+6% top speed — reduced cornering grip",                         speed: 1.06, cornering: 0.88, visual: {lvl: 1, vane: 1, frontSweep: 0.03, frontTaper: 0.96, frontRise: 0.02, rearSweep: 0.04, rearTaper: 0.94, floorEdge: 0.88, floorCut: 0.06, diffuserRise: 0.82, fin: 0.8}, visualTier: 0 },
        { id: "s_duct",        label: "S-Duct",         cost:  60, desc: "Shaped duct package — front aero efficiency with grip trade-off", speed: 1.04, cornering: 0.93, visual: {lvl: 1, vane: 2, frontSweep: 0.08, frontTaper: 0.92, frontRise: 0.05, rearSweep: 0.03, rearTaper: 0.96, floorEdge: 0.9, floorCut: 0.1, diffuserRise: 0.84, fin: 0.9}, visualTier: 0 },
        ...
        { id: "beam_wing",     label: "Beam Wing",      cost:  50, desc: "Rear beam wing — cornering and braking from low-drag base",      speed: 0.99, cornering: 1.07, braking: 1.04, visual: {lvl: 2, beam: 1, vane: 1, frontSweep: 0.04, frontTaper: 0.97, frontRise: 0.04, rearSweep: 0.07, rearTaper: 0.93, floorEdge: 0.98, floorCut: 0.05, diffuserRise: 1.06, fin: 1.12}, visualTier: 2 },
        { id: "rake_setup",    label: "Rake Setup",     cost:  90, desc: "High-rear rake — improved cornering and braking",                speed: 0.97, cornering: 1.10, braking: 1.08, visual: {lvl: 3, vane: 2, frontSweep: 0.06, frontTaper: 0.94, frontRise: 0.07, rearSweep: 0.08, rearTaper: 0.94, floorEdge: 1.04, floorCut: 0.11, diffuserRise: 1.12, fin: 1.2}, visualTier: 2 },
        { id: "diffuser",      label: "Diffuser Focus", cost: 100, desc: "Rear diffuser package — cornering and braking bias",             speed: 0.98, cornering: 1.18, braking: 1.06, visual: {lvl: 3, beam: 1, vane: 2, frontSweep: 0.05, frontTaper: 0.96, frontRise: 0.06, rearSweep: 0.07, rearTaper: 0.92, floorEdge: 1.1, floorCut: 0.14, diffuserRise: 1.28, fin: 1.05}, visualTier: 2 },
        { id: "high",          label: "High DF",        cost:  80, desc: "−5% top speed, strong cornering grip",                          speed: 0.95, cornering: 1.15, visual: {lvl: 3.25, vane: 2, frontSweep: 0.08, frontTaper: 0.91, frontRise: 0.09, rearSweep: 0.09, rearTaper: 0.9, floorEdge: 1.08, floorCut: 0.1, diffuserRise: 1.16, fin: 1.28}, visualTier: 2 },
        { id: "underfloor",    label: "Underfloor Kit", cost: 120, desc: "Enhanced tunnel floors — high grip with less drag penalty",      speed: 0.94, cornering: 1.22, visual: {lvl: 3, beam: 1, vane: 3, frontSweep: 0.07, frontTaper: 0.93, frontRise: 0.08, rearSweep: 0.06, rearTaper: 0.94, floorEdge: 1.24, floorCut: 0.18, diffuserRise: 1.26, fin: 0.86}, visualTier: 2 },
        { id: "extreme",       label: "Extreme DF",     cost: 130, desc: "Maximum downforce — Monaco / Singapore spec",                   speed: 0.89, cornering: 1.26, visual: {lvl: 4, vane: 3, frontSweep: 0.12, frontTaper: 0.86, frontRise: 0.14, rearSweep: 0.12, rearTaper: 0.86, floorEdge: 1.18, floorCut: 0.16, diffuserRise: 1.3, fin: 1.42}, visualTier: 2 },
        { id: "active_aero",   label: "Active Aero",    cost: 160, desc: "Adaptive aero surfaces — speed and cornering in one package",    speed: 1.03, cornering: 1.18, visual: {lvl: 3, drs: 1, vane: 2, frontSweep: 0.1, frontTaper: 0.9, frontRise: 0.1, rearSweep: 0.14, rearTaper: 0.88, floorEdge: 1.06, floorCut: 0.12, diffuserRise: 1.14, fin: 1.34}, visualTier: 2 },
        ...
        { id: "sig_williams_lowdrag", label: "Grove Low-Drag", cost: 40, teams: ["williams"], tag: "SIGNATURE", equivalent: "low",
          desc: "Williams signature straight-line package — Low DF performance with stripped turning vanes", speed: 1.06, cornering: 0.88, visual: {lvl: 1.15, vane: 0, beam: 0, drs: 0, frontSweep: -0.02, frontTaper: 1.02, frontRise: 0.01, rearSweep: 0.01, rearTaper: 0.92, floorEdge: 0.86, floorCut: 0.03, diffuserRise: 0.8, fin: 0.65}, visualTier: 0 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "sport",           label: "Sport",           cost:  50, desc: "Stiffer setup — improved cornering response",                            cornering: 1.08, visual: {ride: -0.01, arm: 1.05, push: 0, rocker: 1, wishbone: 1.08}, visualTier: 2 },
        ...
        { id: "kerb_spec",       label: "Kerb Spec",       cost:  70, desc: "Circuit-tuned stiffness — helps cornering and braking",                  cornering: 1.11, braking: 1.05, visual: {ride: 0.01, arm: 1.1, push: 0, pull: 1, wishbone: 0.9}, visualTier: 2 },
        ...
        { id: "sig_racingbulls_susp", label: "Faenza Chassis", cost: 50, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "sport",
          desc: "Racing Bulls signature chassis — Sport performance with slimline carbon arms", cornering: 1.08, visual: {ride: -0.004, arm: 1.008, push: 1, wishbone: 1.04, toe: 0.96, rocker: 0, heave: 1}, visualTier: 2 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "sig_ferrari_brembo", label: "Maranello Brembo", cost: 160, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "brembo_evo",
          desc: "Ferrari signature brake package — Brembo Evo performance with red monobloc hardware", braking: 1.26, accel: 1.04, visual: {cal: [0.95, 0.05, 0.04], duct: 1.7, rim: [0.52, 0.45, 0.2], discFace: 2, caliper: 1, caliperPos: 5.2, rotorScale: 1.07}, visualTier: 2 },
        { id: "sig_haas_carbonmag", label: "Kannapolis C-Mag", cost: 120, teams: ["haas"], tag: "SIGNATURE", equivalent: "carbon_mag",
          desc: "Haas signature lightweight brake — Carbon-Mag performance with pale alloy hardware", braking: 1.20, accel: 1.03, visual: {cal: [0.88, 0.88, 0.9], duct: 1.42, rim: [0.42, 0.18, 0.14], discFace: 0, caliper: 2, scoop: 2, rotorScale: 1.06, caliperPos: 0.9}, visualTier: 2 },
        { id: "sig_mercedes_discs", label: "Brackley Discs", cost: 140, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "ceramic",
          desc: "Mercedes signature brake package — Carbon Ceramic performance with Petronas-teal hardware", braking: 1.24, visual: {cal: [0, 0.75, 0.7], duct: 1.55, rim: [0.6, 0.62, 0.66], discFace: 1, caliper: 1, caliperPos: 1.6, rotorScale: 1.05}, visualTier: 2 },
        { id: "sig_aston_carbon", label: "Lagonda Carbon", cost: 100, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "ventilated",
          desc: "Aston Martin signature vented brake — Ventilated Carbon performance with racing-green monoblocs", braking: 1.18, visual: {cal: [0, 0.55, 0.38], duct: 1.4, rim: [0.5, 0.44, 0.2], discFace: 2, caliper: 2, scoop: 2, caliperPos: 4, rotorScale: 0.94}, visualTier: 2 },
        ...
        { id: "sig_alpine_brakes", label: "Enstone Brake Pack", cost: 100, teams: ["alpine"], tag: "SIGNATURE", equivalent: "ventilated",
          desc: "Alpine signature brake pack — Ventilated Carbon performance with a duct winglet", braking: 1.18, visual: {cal: [1, 0.53, 0.74], duct: 1.296, scoop: 1, discFace: 2, caliper: 2, rotorScale: 1.08, caliperPos: 2.2}, visualTier: 2 },
    ...
    },
    {
      ...
      options: [
        { id: "intermediate", label: "Intermediate",  cost:   0, desc: "Wet-weather compound — lower grip in dry conditions",                         speed: 0.92, cornering: 0.94, accel: 0.93, visual: {band: [0.1, 0.72, 0.24], grooves: 3, grooveDepth: 0.055, bandWidth: 0.08, coverVanes: 5}, visualTier: 0 },
        { id: "hard",         label: "Hard",          cost:   0, desc: "Durable compound — +2% top speed, lower grip",                               speed: 1.02, cornering: 0.92, accel: 0.97, visual: {band: [0.9, 0.9, 0.93], grooves: 0, bandWidth: 0.05, coverVanes: 8}, visualTier: 0 },
        { id: "medium",       label: "Medium",        cost:   0, desc: "Balanced compound for all conditions",                                        speed: 1.00, cornering: 1.00, accel: 1.00, visual: {band: [0.96, 0.8, 0.1], grooves: 0, bandWidth: 0.075, coverVanes: 6}, visualTier: 1 },
        { id: "slick_track",  label: "Slick Track",   cost:  40, desc: "Pure dry-weather slick — optimised compound structure",                       speed: 1.01, cornering: 1.04, accel: 1.01, visual: {band: [0.8, 0.82, 0.88], grooves: 0, bandWidth: 0.045, coverVanes: 10}, visualTier: 1 },
        { id: "compound_c4",  label: "Compound C4",   cost:  60, desc: "Pirelli's track-ready soft — reliable grip upgrade over Hard/Medium",         speed: 0.98, cornering: 1.08, accel: 1.02, visual: {band: [0.95, 0.42, 0.1], grooves: 0, bandWidth: 0.085, coverVanes: 7}, visualTier: 2 },
        { id: "soft",         label: "Soft",          cost:  80, desc: "+12% cornering, +4% accel — some top speed drag",                            speed: 0.97, cornering: 1.12, accel: 1.04, visual: {band: [0.92, 0.12, 0.1], grooves: 0, bandWidth: 0.1, coverVanes: 6, shoulder: 1}, visualTier: 2 },
        { id: "compound_c5",  label: "Compound C5",   cost: 100, desc: "High-spec soft — aggressive grip over one stint, strong accel",               speed: 0.96, cornering: 1.15, accel: 1.05, visual: {band: [0.97, 0.16, 0.12], grooves: 0, bandWidth: 0.115, coverVanes: 5, shoulder: 1}, visualTier: 2 },
        { id: "supersoft",    label: "Super Soft",    cost: 130, desc: "High grip compound — aggressive tyre load",                                   speed: 0.94, cornering: 1.20, accel: 1.06, visual: {band: [0.88, 0.1, 0.3], grooves: 0, bandWidth: 0.12, coverVanes: 8, shoulder: 2}, visualTier: 2 },
        { id: "p_zero_red",   label: "P Zero Red",    cost: 160, desc: "Custom Pirelli high-performance compound — between Super Soft and Quali",     speed: 0.92, cornering: 1.24, accel: 1.07, visual: {sidewall: 1, band: [0.97, 0.07, 0.07], grooves: 0, bandWidth: 0.13, coverVanes: 9}, visualTier: 2 },
        { id: "qualigum",     label: "Quali Spec",    cost: 180, desc: "One-lap ultra-soft — maximum short-run grip",                                 speed: 0.91, cornering: 1.28, accel: 1.09, visual: {sidewall: 2, band: [0.62, 0.12, 0.78], grooves: 0, bandWidth: 0.14, coverVanes: 11}, visualTier: 2 },
        { id: "hypersoft",    label: "Hyper Soft",    cost: 200, desc: "Prototype extreme compound — maximum peak grip, very short lifespan",          speed: 0.88, cornering: 1.36, accel: 1.12, visual: {sidewall: 2, band: [0.98, 0.38, 0.62], grooves: 0, bandWidth: 0.15, coverVanes: 12, shoulder: 2}, visualTier: 2 },
        { id: "sprint_soft",  label: "Sprint Soft",   cost: 150, desc: "Short-race compound — rapid warm-up and strong launch traction",                 speed: 0.93, cornering: 1.22, accel: 1.08, visual: {band: [0.15, 0.55, 0.95], grooves: 0, bandWidth: 0.105, coverVanes: 9}, visualTier: 2 },
        { id: "wet_full",     label: "Full Wet",      cost:   0, desc: "Deep-tread monsoon tyre — the only compound that clears standing water",         speed: 0.88, cornering: 0.90, accel: 0.90, visual: {band: [0.1, 0.4, 0.92], grooves: 4, grooveDepth: 0.075, bandWidth: 0.09, coverVanes: 4, shoulder: 2}, visualTier: 0 },
        { id: "compound_c3",  label: "Compound C3",   cost:  50, desc: "Pirelli's workhorse medium-hard — a small, safe step up from the base compound", speed: 1.01, cornering: 1.05, accel: 1.01, visual: {band: [0.92, 0.92, 0.6], grooves: 0, bandWidth: 0.065, coverVanes: 9, shoulder: 2}, visualTier: 1 },
        { id: "endurance_tyre", label: "Endurance Spec", cost: 70, desc: "Reinforced casing — holds its shape lap after lap without giving up top speed", speed: 1.02, cornering: 1.06, accel: 1.00, visual: {sidewall: 1, band: [0.55, 0.58, 0.64], grooves: 0, bandWidth: 0.055, coverVanes: 12, shoulder: 1}, visualTier: 1 },
        { id: "branded_wall", label: "Branded Wall", cost: 30, desc: "Double raised lettering rings on the sidewall — the promoter's compound, medium underneath", cornering: 1.02, visual: {sidewall: 2, band: [0.94, 0.94, 0.96], grooves: 0, bandWidth: 0.06, coverVanes: 6, shoulder: 0}, visualTier: 1 },
        { id: "sig_cadillac_sprint", label: "Cadillac Sprint", cost: 150, teams: ["cadillac"], tag: "SIGNATURE", equivalent: "sprint_soft",
          desc: "Cadillac signature sprint compound — Sprint Soft performance with a gold double-width band", speed: 0.93, cornering: 1.22, accel: 1.08, visual: {sidewall: 2, band: [0.92, 0.72, 0.18], grooves: 0, bandWidth: 0.125, coverVanes: 4, shoulder: 2}, visualTier: 2 },
        { id: "sig_rb_street", label: "Faenza Street", cost: 130, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "supersoft",
          desc: "Racing Bulls signature street compound — Super Soft performance with a twin-blue sidewall band", speed: 0.94, cornering: 1.20, accel: 1.06, visual: {sidewall: 1, band: [0.2, 0.3, 0.95], grooves: 0, bandWidth: 0.135, coverVanes: 7, shoulder: 1}, visualTier: 2 },
        ...
        { id: "sig_ferrari_tyre", label: "Maranello Compound", cost: 80, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Ferrari signature compound — Soft performance with a 6-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, visual: {sidewall: 1, band: [0.98, 0.78, 0.06], grooves: 0, bandWidth: 0.125, coverVanes: 5, shoulder: 1}, visualTier: 2 },
        { id: "sig_mclaren_tyre", label: "Woking Compound", cost: 150, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "sprint_soft",
          desc: "McLaren signature compound — Sprint Soft performance with a 11-vane wheel cover", speed: 0.93, accel: 1.08, cornering: 1.22, visual: {sidewall: 2, band: [1, 0.47, 0], grooves: 0, bandWidth: 0.118, coverVanes: 12, shoulder: 1}, visualTier: 2 },
        { id: "sig_redbull_tyre", label: "Milton Keynes Compound", cost: 80, teams: ["redbull"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Red Bull signature compound — Soft performance with a 8-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, visual: {sidewall: 2, band: [0.1, 0.2, 0.72], grooves: 0, bandWidth: 0.115, coverVanes: 7, shoulder: 2}, visualTier: 2 },
        { id: "sig_alpine_tyre", label: "Enstone Compound", cost: 60, teams: ["alpine"], tag: "SIGNATURE", equivalent: "compound_c4",
          desc: "Alpine signature compound — Compound C4 performance with a 7-vane wheel cover", speed: 0.98, accel: 1.02, cornering: 1.08, visual: {sidewall: 1, band: [1, 0.53, 0.74], grooves: 1, bandWidth: 0.128, coverVanes: 10, shoulder: 1, grooveDepth: 0.05}, visualTier: 2 },
        { id: "sig_haas_tyre", label: "Kannapolis Compound", cost: 0, teams: ["haas"], tag: "SIGNATURE", equivalent: "hard",
          desc: "Haas signature compound — Hard performance with a 5-vane wheel cover", speed: 1.02, accel: 0.97, cornering: 0.92, visual: {sidewall: 2, band: [0.86, 0.16, 0.11], grooves: 0, bandWidth: 0.095, coverVanes: 8, shoulder: 1}, visualTier: 0 },
        { id: "sig_williams_tyre", label: "Grove Compound", cost: 0, teams: ["williams"], tag: "SIGNATURE", equivalent: "hard",
          desc: "Williams signature compound — Hard performance with a 12-vane wheel cover", speed: 1.02, accel: 0.97, cornering: 0.92, visual: {sidewall: 2, band: [0.15, 0.42, 0.95], grooves: 0, bandWidth: 0.082, coverVanes: 6, shoulder: 2}, visualTier: 0 },
        { id: "sig_audi_tyre", label: "Neuburg Compound", cost: 60, teams: ["audi"], tag: "SIGNATURE", equivalent: "compound_c4",
          desc: "Audi signature compound — Compound C4 performance with a 4-vane wheel cover", speed: 0.98, accel: 1.02, cornering: 1.08, visual: {sidewall: 1, band: [0.75, 0.1, 0.3], grooves: 0, bandWidth: 0.135, coverVanes: 11, shoulder: 1}, visualTier: 2 },
        { id: "sig_astonmartin_tyre", label: "Silverstone Compound", cost: 80, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Aston Martin signature compound — Soft performance with a 3-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, visual: {sidewall: 2, band: [0.72, 0.88, 0.11], grooves: 0, bandWidth: 0.072, coverVanes: 4, shoulder: 2}, visualTier: 2 },
      ],
    },
    {
      id: "ers", label: "ERS",
      options: [
        ...
        { id: "regen_plus",     label: "Regen+",        cost:  70, desc: "Enhanced braking recovery — harvests extra energy under braking",            braking: 1.05, accel: 1.05, visual: {led: [0.12, 1.5, 0.55], pack: 1.05, blister: 1, cells: 4}, visualTier: 1 },
        { id: "harvest",        label: "Harvest",       cost:  60, desc: "Aggressive recovery: +2% top speed, −5% accel",                             speed: 1.02, accel: 0.95, visual: {led: [0.18, 1.35, 0.95], pack: 0.95, conduit: 1, coolerIntake: 1}, visualTier: 0 },
        { id: "split_deploy",   label: "Split Deploy",  cost:  90, desc: "Per-axle deployment control — improved cornering traction and accel",        accel: 1.06, cornering: 1.04, visual: {led: [0.85, 0.55, 1.7], pack: 1.1, blister: 2, cells: 5}, visualTier: 1 },
        { id: "mgu_k_max",      label: "MGU-K Max",     cost:  80, desc: "Dedicated kinetic unit — strong deployment burst on straights",              accel: 1.08, speed: 0.98, visual: {led: [1.7, 0.95, 0.15], pack: 1.15, coolerIntake: 1, cells: 5}, visualTier: 2 },
        ...
        { id: "torque_fill",    label: "Torque Fill",   cost: 120, desc: "Hybrid torque-vectoring — cornering traction and exit speed",                accel: 1.08, cornering: 1.06, visual: {led: [0.8, 0.3, 1.85], pack: 1.15, conduit: 1, blister: 1}, visualTier: 2 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "wrapped_single", label: "Wrapped Single",  cost:  45, desc: "Single wrapped pipe — heat kept off the bodywork, modest gain", accel: 1.04, visual: { pipes: 1, bore: 1.04, flare: 0.5, wastegate: 0, wrap: 1, lip: 2, shield: 1 }, visualTier: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "faired_halo",label: "Faired Halo",   cost:  40, desc: "Aero fairing over the halo — cleans up the flow to the airbox",              speed: 1.02, visual: {halo: 1, haloBlade: 1, haloWing: 0, camPods: 0, screen: 0, headrest: 1}, visualTier: 1 },
        { id: "twin_cam",   label: "Twin T-Cam",    cost:  30, desc: "Second camera pod — broadcast spec, and a touch more roll-hoop drag",        speed: 0.99, cornering: 1.02, visual: {headrest: 1, haloBlade: 0, haloWing: 0, camPods: 2, screen: 0, mirror: 1.28}, visualTier: 1 },
        { id: "deflector",  label: "Deflector",     cost:  60, desc: "Cockpit deflector — steadier air over the driver at speed",                  speed: 1.03, braking: 1.02, visual: {headrest: 1, haloBlade: 1, haloWing: 0, camPods: 1, screen: 1, mirror: 1.18}, visualTier: 2 },
        { id: "halo_wing",  label: "Halo Wing",     cost: 110, desc: "Upper halo flap — real downforce from the cockpit structure itself",         speed: 0.99, cornering: 1.07, visual: {headrest: 2, haloBlade: 1, haloWing: 1, camPods: 1, screen: 0, mirror: 0.9}, visualTier: 2 },
        { id: "full_shroud",label: "Full Shroud",   cost: 160, desc: "Fully faired halo with flap and deflector — the complete cockpit package",   speed: 1.01, cornering: 1.08, braking: 1.02, visual: {halo: 2, headrest: 2, haloBlade: 2, haloWing: 1, camPods: 2, screen: 1, mirror: 1.32}, visualTier: 2 },
        { id: "open_cell",     label: "Open Cell",       cost:  20, desc: "Stripped surround — the lightest legal cockpit, no shrouding at all", accel: 1.03, cornering: 0.99, visual: {halo: 1, headrest: 0, haloBlade: 0, haloWing: 0, camPods: 1, screen: 0}, visualTier: 0 },
        { id: "twin_pod_screen", label: "Twin Pod Screen", cost:  75, desc: "Twin camera pods either side of a raised screen — steadier air over the airbox", speed: 1.02, cornering: 1.03, visual: {halo: 1, headrest: 1, haloBlade: 1, haloWing: 0, camPods: 2, screen: 1, mirror: 1.22}, visualTier: 1 },
        ...
        { id: "halo_fence", label: "Fenced Halo",   cost:  90, desc: "Crest vanes along the halo crown — conditions the flow into the airbox",   speed: 0.98, cornering: 1.05, visual: {halo: 2, headrest: 1, haloBlade: 0, haloWing: 0, camPods: 0, screen: 0, mirror: 0.88}, visualTier: 2 },
        { id: "sig_mercedes_cpit", label: "Brackley Cockpit", cost: 110, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "halo_wing",
          desc: "Mercedes signature cockpit — Halo Wing performance with a bladed halo", speed: 0.99, cornering: 1.07, visual: {halo: 1, headrest: 1, haloBlade: 2, haloWing: 1, camPods: 1, screen: 0, mirror: 1.3}, visualTier: 2 },
        { id: "sig_ferrari_cpit", label: "Maranello Cockpit", cost: 160, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "full_shroud",
          desc: "Ferrari signature cockpit — Full Shroud performance with a fully faired halo and an upper flap", speed: 1.01, cornering: 1.08, braking: 1.02, visual: {halo: 2, headrest: 1, haloBlade: 2, haloWing: 1, camPods: 0, screen: 0, mirror: 0.87}, visualTier: 2 },
        { id: "sig_mclaren_cpit", label: "Woking Cockpit", cost: 110, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "halo_wing",
          desc: "McLaren signature cockpit — Halo Wing performance with a bladed halo and an upper flap", speed: 0.99, cornering: 1.07, visual: {halo: 0, headrest: 2, haloBlade: 1, haloWing: 1, camPods: 2, screen: 1, mirror: 1.24}, visualTier: 2 },
        { id: "sig_redbull_cpit", label: "Milton Keynes Cockpit", cost: 60, teams: ["redbull"], tag: "SIGNATURE", equivalent: "deflector",
          desc: "Red Bull signature cockpit — Deflector performance with an upper halo flap", speed: 1.03, braking: 1.02, visual: {halo: 1, headrest: 2, haloBlade: 0, haloWing: 1, camPods: 1, screen: 0, mirror: 0.92}, visualTier: 2 },
        { id: "sig_alpine_cpit", label: "Enstone Cockpit", cost: 40, teams: ["alpine"], tag: "SIGNATURE", equivalent: "faired_halo",
          desc: "Alpine signature cockpit — Faired Halo performance with a bladed halo and an upper flap", speed: 1.02, visual: {halo: 0, headrest: 1, haloBlade: 1, haloWing: 1, camPods: 0, screen: 0, mirror: 1.14}, visualTier: 1 },
        { id: "sig_racingbulls_cpit", label: "Faenza Cockpit", cost: 30, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "twin_cam",
          desc: "Racing Bulls signature cockpit — Twin T-Cam performance with a bare halo", speed: 0.99, cornering: 1.02, visual: {halo: 1, headrest: 0, haloBlade: 0, haloWing: 0, camPods: 1, screen: 1, mirror: 1.35}, visualTier: 1 },
        ...
        { id: "sig_williams_cpit", label: "Grove Cockpit", cost: 40, teams: ["williams"], tag: "SIGNATURE", equivalent: "faired_halo",
          desc: "Williams signature cockpit — Faired Halo performance with a bladed halo", speed: 1.02, visual: {halo: 2, headrest: 0, haloBlade: 1, haloWing: 0, camPods: 2, screen: 1, mirror: 1.2}, visualTier: 1 },
        { id: "sig_audi_cpit", label: "Neuburg Cockpit", cost: 60, teams: ["audi"], tag: "SIGNATURE", equivalent: "deflector",
          desc: "Audi signature cockpit — Deflector performance with a fully faired halo", speed: 1.03, braking: 1.02, visual: {halo: 2, headrest: 2, haloBlade: 2, haloWing: 1, camPods: 2, screen: 0, mirror: 0.95}, visualTier: 2 },
        { id: "sig_astonmartin_cpit", label: "Silverstone Cockpit", cost: 160, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "full_shroud",
          desc: "Aston Martin signature cockpit — Full Shroud performance with a fully faired halo and an upper flap", speed: 1.01, cornering: 1.08, braking: 1.02, visual: {halo: 1, headrest: 1, haloBlade: 2, haloWing: 1, camPods: 1, screen: 1, mirror: 1.26}, visualTier: 2 },
        { id: "sig_cadillac_cpit", label: "Detroit Cockpit", cost: 30, teams: ["cadillac"], tag: "SIGNATURE", equivalent: "twin_cam",
          desc: "Cadillac signature cockpit — Twin T-Cam performance with a bladed halo", speed: 0.99, cornering: 1.02, visual: {halo: 0, headrest: 2, haloBlade: 1, haloWing: 0, camPods: 1, screen: 0, mirror: 1.08}, visualTier: 1 },
      ],
    },
    {
      ...
      options: [
        ...
        { id: "dished",    label: "Dished Cover", cost:  60, desc: "Recessed cover face — cleaner flow off the wheel at speed",                 speed: 1.03, visual: {spokes: 0, tape: 0, dish: 1, nut: [0.7, 0.72, 0.78], gunNut: 1, deflector: 1}, visualTier: 1 },
        { id: "taped",     label: "Taped Rim",    cost:  50, desc: "Banded rim shoulder — seals the bead and marks the set at a glance",        cornering: 1.04, visual: {spokes: 4, tape: 1, dish: 0, nut: [0.95, 0.2, 0.15], gunNut: 1}, visualTier: 1 },
