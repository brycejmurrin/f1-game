...
const Parts = (function () {
  ...
  const CATALOG = [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "racing",          label: "Racing",          cost:  90, desc: "Track-focused — high lateral grip",                                      cornering: 1.16, visual: {"ride": -0.025, "arm": 1.15, "push": 1, rocker: 1}, visualTier: 2 },
        ...
        { id: "heave_spring",    label: "Heave Spring",    cost: 150, desc: "Aero-optimised springing — stable floor clearance under hard braking",   cornering: 1.21, speed: 1.03, visual: {"ride": -0.03, "arm": 1.2, "push": 1, "pull": 1, rocker: 2}, visualTier: 2 },
        { id: "active",          label: "Active",          cost: 190, desc: "Active suspension system — peak cornering, slight top speed boost",       cornering: 1.28, speed: 1.02, visual: {"ride": -0.045, "arm": 1.25, "push": 1, rocker: 2}, visualTier: 2 },
        ...
        { id: "zero_keel",       label: "Zero Keel",       cost:  85, desc: "Keel-less front end — cleaner airflow under the nose with a stiffer platform", cornering: 1.13, braking: 1.03, visual: { ride: -0.022, arm: 1.02, push: 1, wishbone: 0.82, toe: 0.92, rocker: 1 }, visualTier: 2 },
        { id: "mono_damper",     label: "Monotube Damper", cost: 140, desc: "Monotube gas dampers — precise control with a useful mass saving",          cornering: 1.20, accel: 1.02, visual: { ride: -0.032, arm: 1.06, push: 1, pull: 1, wishbone: 1.24, toe: 1.16, rocker: 2 }, visualTier: 2 },
        { id: "sig_redbull_pullrod", label: "Milton Keynes Pullrod", cost: 190, teams: ["redbull"], tag: "SIGNATURE", equivalent: "active",
          desc: "Red Bull signature pullrod layout — Active performance with a distinct crossed actuator", cornering: 1.28, speed: 1.02, visual: { ride: -0.043, arm: 1.28, push: 1, pull: 1, rocker: 0 }, visualTier: 2 },
        { id: "sig_mclaren_active", label: "Woking Active", cost: 190, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "active",
          desc: "McLaren signature adaptive platform — Active performance with slimline carbon arms", cornering: 1.28, speed: 1.02, visual: { ride: -0.047, arm: 0.92, push: 1, pull: 1, rocker: 2 }, visualTier: 2 },
        ...
        { id: "sig_mercedes_susp", label: "Brackley Chassis", cost: 170, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "interlinked",
          desc: "Mercedes signature chassis — Interlinked performance with a crossed pullrod actuator", speed: 1.01, cornering: 1.23, braking: 1.05, visual: { ride: -0.024, arm: 1.053, push: 1, pull: 1, wishbone: 1.06, toe: 0.94, rocker: 2 }, visualTier: 2 },
        ...
        { id: "sig_williams_susp", label: "Grove Chassis", cost: 80, teams: ["williams"], tag: "SIGNATURE", equivalent: "low_ride",
          desc: "Williams signature chassis — Low Ride Height performance with slimline carbon arms", speed: 1.02, cornering: 1.12, visual: { ride: -0.037, arm: 0.924, push: 0, wishbone: 1.12, toe: 0.88, rocker: 0 }, visualTier: 2 },
        { id: "sig_astonmartin_susp", label: "Silverstone Chassis", cost: 150, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "heave_spring",
          desc: "Aston Martin signature chassis — Heave Spring performance with a crossed pullrod actuator", speed: 1.03, cornering: 1.21, visual: { ride: -0.042, arm: 1.272, push: 1, pull: 1, wishbone: 0.94, toe: 1.06, rocker: 1 }, visualTier: 2 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "carbon",      label: "Carbon",           cost:  90, desc: "F1-spec carbon composite brakes",                                           braking: 1.16, visual: {"cal": [0.85, 0.12, 0.1], "duct": 1.25, discFace: 1}, visualTier: 2 },
        { id: "ventilated",  label: "Ventilated Carbon",cost: 100, desc: "Internally vented discs — consistent fade-free stopping",                   braking: 1.18, visual: {"cal": [0.9, 0.15, 0.12], "duct": 1.35, discFace: 1}, visualTier: 2 },
        ...
        { id: "ceramic",     label: "Carbon Ceramic",   cost: 140, desc: "Maximum stopping power — zero fade",                                        braking: 1.24, visual: {"cal": [0.97, 0.1, 0.08], "duct": 1.6, "rim": [0.55, 0.56, 0.6], discFace: 2}, visualTier: 2 },
        ...
        { id: "scoop_wrap",   label: "Wrapped Ducts",    cost: 110, desc: "Boomerang duct fairings wrapping the wheel face — cooling that also turns air", braking: 1.19, cornering: 1.02, visual: { cal: [0.20, 0.55, 0.85], duct: 1.30, scoop: 2, rim: [0.26, 0.30, 0.36], discFace: 1 }, visualTier: 2 },
        { id: "cryo_pack",    label: "Cryo Pack",        cost: 150, desc: "Cryogenically treated discs — deep, repeatable stopping power under load",     braking: 1.25, accel: 1.02, visual: { cal: [0.72, 0.86, 0.95], duct: 1.62, scoop: 2, rim: [0.50, 0.54, 0.60], discFace: 2 }, visualTier: 2 },
        { id: "sig_ferrari_brembo", label: "Maranello Brembo", cost: 160, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "brembo_evo",
          desc: "Ferrari signature brake package — Brembo Evo performance with red monobloc hardware", braking: 1.26, accel: 1.04, visual: { cal: [0.95, 0.05, 0.04], duct: 1.70, rim: [0.52, 0.45, 0.20], discFace: 2 }, visualTier: 2 },
        { id: "sig_haas_carbonmag", label: "Kannapolis C-Mag", cost: 120, teams: ["haas"], tag: "SIGNATURE", equivalent: "carbon_mag",
          desc: "Haas signature lightweight brake — Carbon-Mag performance with pale alloy hardware", braking: 1.20, accel: 1.03, visual: { cal: [0.88, 0.88, 0.90], duct: 1.42, rim: [0.42, 0.18, 0.14], discFace: 0 }, visualTier: 2 },
        { id: "sig_mercedes_discs", label: "Brackley Discs", cost: 140, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "ceramic",
          desc: "Mercedes signature brake package — Carbon Ceramic performance with Petronas-teal hardware", braking: 1.24, visual: { cal: [0.0, 0.75, 0.70], duct: 1.55, rim: [0.60, 0.62, 0.66], discFace: 1 }, visualTier: 2 },
        { id: "sig_aston_carbon", label: "Lagonda Carbon", cost: 100, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "ventilated",
          desc: "Aston Martin signature vented brake — Ventilated Carbon performance with racing-green monoblocs", braking: 1.18, visual: { cal: [0.0, 0.55, 0.38], duct: 1.40, rim: [0.50, 0.44, 0.20], discFace: 2 }, visualTier: 2 },
        ...
        { id: "sig_mclaren_brakes", label: "Woking Brake Pack", cost: 180, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "six_piston",
          desc: "McLaren signature brake pack — Six Piston performance with a duct winglet", cornering: 1.02, braking: 1.27, visual: { cal: [1, 0.5, 0], duct: 1.643, rim: [0.24, 0.28, 0.34], scoop: 1, discFace: 1 }, visualTier: 2 },
        { id: "sig_redbull_brakes", label: "Milton Keynes Brake Pack", cost: 120, teams: ["redbull"], tag: "SIGNATURE", equivalent: "carbon_mag",
          desc: "Red Bull signature brake pack — Carbon-Mag performance with wrapped boomerang ducts", accel: 1.03, braking: 1.2, visual: { cal: [0.95, 0.78, 0], duct: 1.624, rim: [0.48, 0.4, 0.16], scoop: 2, discFace: 2 }, visualTier: 2 },
        { id: "sig_alpine_brakes", label: "Enstone Brake Pack", cost: 100, teams: ["alpine"], tag: "SIGNATURE", equivalent: "ventilated",
          desc: "Alpine signature brake pack — Ventilated Carbon performance with a duct winglet", braking: 1.18, visual: { cal: [1, 0.53, 0.74], duct: 1.296, scoop: 1, discFace: 1 }, visualTier: 2 },
        { id: "sig_racingbulls_brakes", label: "Faenza Brake Pack", cost: 40, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "sport",
          desc: "Racing Bulls signature brake pack — Sport performance with bare duct inlets", braking: 1.08, visual: { cal: [0.2, 0.3, 0.95], duct: 0.874, scoop: 0, discFace: 0 }, visualTier: 2 },
        { id: "sig_williams_brakes", label: "Grove Brake Pack", cost: 50, teams: ["williams"], tag: "SIGNATURE", equivalent: "titanium",
          desc: "Williams signature brake pack — Titanium Caliper performance with a duct winglet", accel: 1.04, braking: 1.06, visual: { cal: [0.2, 0.55, 0.95], duct: 0.765, scoop: 1, discFace: 1 }, visualTier: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "hypersoft",    label: "Hyper Soft",    cost: 200, desc: "Prototype extreme compound — maximum peak grip, very short lifespan",          speed: 0.88, cornering: 1.36, accel: 1.12, visual: {"band": [0.98, 0.38, 0.62], "grooved": false, "grooves": 0, "bandWidth": 0.15, "coverVanes": 12, shoulder: 2}, visualTier: 2 },
        ...
        { id: "endurance_tyre", label: "Endurance Spec", cost: 70, desc: "Reinforced casing — holds its shape lap after lap without giving up top speed", speed: 1.02, cornering: 1.06, accel: 1.00, visual: { band: [0.55, 0.58, 0.64], grooved: false, grooves: 0, bandWidth: 0.055, coverVanes: 12, shoulder: 1 }, visualTier: 1 },
        ...
        { id: "sig_ferrari_tyre", label: "Maranello Compound", cost: 80, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Ferrari signature compound — Soft performance with a 6-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, visual: { band: [0.92, 0.12, 0.1], grooved: false, grooves: 0, bandWidth: 0.11, coverVanes: 6, shoulder: 2 }, visualTier: 2 },
        { id: "sig_mclaren_tyre", label: "Woking Compound", cost: 150, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "sprint_soft",
          desc: "McLaren signature compound — Sprint Soft performance with a 11-vane wheel cover", speed: 0.93, accel: 1.08, cornering: 1.22, visual: { band: [0.15, 0.55, 0.95], grooved: false, grooves: 0, bandWidth: 0.109, coverVanes: 11, shoulder: 2 }, visualTier: 2 },
        { id: "sig_redbull_tyre", label: "Milton Keynes Compound", cost: 80, teams: ["redbull"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Red Bull signature compound — Soft performance with a 8-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, visual: { band: [0.92, 0.12, 0.1], grooved: false, grooves: 0, bandWidth: 0.106, coverVanes: 8, shoulder: 1 }, visualTier: 2 },
        { id: "sig_alpine_tyre", label: "Enstone Compound", cost: 60, teams: ["alpine"], tag: "SIGNATURE", equivalent: "compound_c4",
          desc: "Alpine signature compound — Compound C4 performance with a 7-vane wheel cover", speed: 0.98, accel: 1.02, cornering: 1.08, visual: { band: [0.95, 0.42, 0.1], grooved: false, grooves: 0, bandWidth: 0.092, coverVanes: 7, shoulder: 0 }, visualTier: 2 },
        { id: "sig_haas_tyre", label: "Kannapolis Compound", cost: 0, teams: ["haas"], tag: "SIGNATURE", equivalent: "hard",
          desc: "Haas signature compound — Hard performance with a 5-vane wheel cover", speed: 1.02, accel: 0.97, cornering: 0.92, visual: { band: [0.9, 0.9, 0.93], grooved: false, grooves: 0, bandWidth: 0.051, coverVanes: 5, shoulder: 0 }, visualTier: 0 },
        { id: "sig_williams_tyre", label: "Grove Compound", cost: 0, teams: ["williams"], tag: "SIGNATURE", equivalent: "hard",
          desc: "Williams signature compound — Hard performance with a 12-vane wheel cover", speed: 1.02, accel: 0.97, cornering: 0.92, visual: { band: [0.9, 0.9, 0.93], grooved: false, grooves: 0, bandWidth: 0.045, coverVanes: 12, shoulder: 0 }, visualTier: 0 },
        { id: "sig_audi_tyre", label: "Neuburg Compound", cost: 60, teams: ["audi"], tag: "SIGNATURE", equivalent: "compound_c4",
          desc: "Audi signature compound — Compound C4 performance with a 4-vane wheel cover", speed: 0.98, accel: 1.02, cornering: 1.08, visual: { band: [0.95, 0.42, 0.1], grooved: false, grooves: 0, bandWidth: 0.095, coverVanes: 4, shoulder: 2 }, visualTier: 2 },
        { id: "sig_astonmartin_tyre", label: "Silverstone Compound", cost: 80, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Aston Martin signature compound — Soft performance with a 3-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, visual: { band: [0.92, 0.12, 0.1], grooved: false, grooves: 0, bandWidth: 0.1, coverVanes: 3, shoulder: 1 }, visualTier: 2 },
      ],
    },
    {
      id: "ers", label: "ERS",
    ...
    },
    {
      ...
      options: [
        ...
        { id: "sig_alpine_efuel", label: "Viry E-Fuel", cost: 175, teams: ["alpine"], tag: "SIGNATURE", equivalent: "efuel_dense",
          desc: "Alpine signature synthetic blend — Dense E-Fuel performance with a blue-pink burn", speed: 1.045, accel: 1.085, braking: 1.01, visual: { cap: [0.10, 0.72, 1.85], flame: [0.65, 0.32, 1.95], fxFlame: [0.85, 0.65, 2.85], line: 2 }, visualTier: 2 },
        { id: "sig_haas_blend", label: "Kannapolis Blend", cost: 90, teams: ["haas"], tag: "SIGNATURE", equivalent: "race_blend",
          desc: "Haas signature race fuel — Race Blend performance with a stars-and-stripes red burn", speed: 1.02, accel: 1.06, visual: { cap: [1.70, 0.20, 0.15], flame: [1.90, 0.30, 0.25], fxFlame: [2.90, 0.60, 0.40], line: 2 }, visualTier: 1 },
        ...
        { id: "sig_mercedes_fuel", label: "Brackley Blend", cost: 175, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "efuel_dense",
          desc: "Mercedes signature blend — Dense E-Fuel performance with a quick-fill coupling", speed: 1.045, accel: 1.085, braking: 1.01, visual: { cap: [0, 1.2, 1.12], flame: [0.35, 1.55, 1.45], fxFlame: [0.525, 2.325, 2.175], filler: 1, line: 1 }, visualTier: 2 },
        { id: "sig_ferrari_fuel", label: "Maranello Blend", cost: 90, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "race_blend",
          desc: "Ferrari signature blend — Race Blend performance with twin filler couplings", speed: 1.02, accel: 1.06, visual: { cap: [1.52, 0.08, 0.064], flame: [1.9, 0.3, 0.15], fxFlame: [2.85, 0.45, 0.225], filler: 2, line: 2 }, visualTier: 1 },
        { id: "sig_mclaren_fuel", label: "Woking Blend", cost: 175, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "efuel_dense",
          desc: "McLaren signature blend — Dense E-Fuel performance with a quick-fill coupling", speed: 1.045, accel: 1.085, braking: 1.01, visual: { cap: [1.6, 0.8, 0], flame: [1.95, 0.95, 0.1], fxFlame: [2.925, 1.425, 0.15], filler: 1, line: 2 }, visualTier: 2 },
        { id: "sig_redbull_fuel", label: "Milton Keynes Blend", cost: 90, teams: ["redbull"], tag: "SIGNATURE", equivalent: "race_blend",
          desc: "Red Bull signature blend — Race Blend performance with a single-point filler", speed: 1.02, accel: 1.06, visual: { cap: [1.52, 1.248, 0], flame: [1.85, 1.45, 0.2], fxFlame: [2.775, 2.175, 0.3], filler: 0, line: 1 }, visualTier: 1 },
        { id: "sig_racingbulls_fuel", label: "Faenza Blend", cost: 40, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "high_octane",
          desc: "Racing Bulls signature blend — High Octane performance with a quick-fill coupling", accel: 1.05, visual: { cap: [0.32, 0.48, 1.52], flame: [0.45, 0.6, 1.95], fxFlame: [0.675, 0.9, 2.925], filler: 1, line: 1 }, visualTier: 1 },
        { id: "sig_williams_fuel", label: "Grove Blend", cost: 40, teams: ["williams"], tag: "SIGNATURE", equivalent: "high_octane",
          desc: "Williams signature blend — High Octane performance with a single-point filler", accel: 1.05, visual: { cap: [0.32, 0.88, 1.52], flame: [0.55, 1.05, 1.9], fxFlame: [0.825, 1.575, 2.85], filler: 0, line: 1 }, visualTier: 1 },
        { id: "sig_audi_fuel", label: "Neuburg Blend", cost: 50, teams: ["audi"], tag: "SIGNATURE", equivalent: "biofuel",
          desc: "Audi signature blend — Biofuel 100 performance with a quick-fill coupling", accel: 1.03, braking: 1.04, visual: { cap: [1.568, 0.448, 0.08], flame: [2, 0.45, 0.15], fxFlame: [3, 0.675, 0.225], filler: 1, line: 2 }, visualTier: 1 },
        { id: "sig_astonmartin_fuel", label: "Silverstone Blend", cost: 200, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "custom_formula",
          desc: "Aston Martin signature blend — Custom Formula performance with twin filler couplings", speed: 1.05, accel: 1.09, cornering: 1.02, braking: 1.02, visual: { cap: [1.152, 1.408, 0.176], flame: [1.1, 1.9, 0.3], fxFlame: [1.65, 2.85, 0.45], filler: 2, line: 2 }, visualTier: 2 },
        { id: "sig_cadillac_fuel", label: "Detroit Blend", cost: 175, teams: ["cadillac"], tag: "SIGNATURE", equivalent: "efuel_dense",
          desc: "Cadillac signature blend — Dense E-Fuel performance with twin filler couplings", speed: 1.045, accel: 1.085, braking: 1.01, visual: { cap: [1.36, 1.12, 0.512], flame: [1.8, 1.35, 0.5], fxFlame: [2.7, 2.025, 0.75], filler: 2, line: 1 }, visualTier: 2 },
      ],
    },
    {
      id: "exhaust", label: "EXHAUST",
      options: [
        { id: "stock",      label: "Stock",          cost:   0, desc: "Factory tailpipe, sized to the power unit's own plumbing",                    visual: { pipes: null, bore: 1, flare: 0, wastegate: 0, wrap: 0 }, visualTier: 1 },
        { id: "sport_cat",  label: "Sport Cat",      cost:  30, desc: "Freer catalyst section — a little less back-pressure everywhere",             accel: 1.03, visual: { pipes: null, bore: 1.08, flare: 0, wastegate: 0, wrap: 0 }, visualTier: 1 },
        { id: "free_flow",  label: "Free Flow",      cost:  60, desc: "Straight-through primaries — cleaner scavenging high in the rev range",       speed: 1.03, accel: 1.03, visual: { pipes: null, bore: 1.18, flare: 0, wastegate: 0, wrap: 1 }, visualTier: 1 },
        { id: "megaphone",  label: "Megaphone",      cost:  90, desc: "Flared megaphone exit — strong mid-range for a little top end",               speed: 1.01, accel: 1.06, visual: { pipes: 1, bore: 1.22, flare: 1, wastegate: 0, wrap: 0 }, visualTier: 2 },
        { id: "twin_gate",  label: "Twin Wastegate", cost: 110, desc: "Twin wastegate stacks — sharper boost response out of slow corners",          speed: 1.01, accel: 1.07, visual: { pipes: null, bore: 1.10, flare: 0, wastegate: 2, wrap: 1 }, visualTier: 2 },
        { id: "inconel",    label: "Inconel Race",   cost: 140, desc: "Thin-wall Inconel system — mass saving with a broad power gain",              speed: 1.04, accel: 1.05, visual: { pipes: 3, bore: 1.05, flare: 0, wastegate: 0, wrap: 1 }, visualTier: 2 },
        { id: "tri_exit",   label: "Tri-Exit",       cost: 170, desc: "Three-pipe exit — the classic scavenging layout in race trim",                speed: 1.04, accel: 1.07, visual: { pipes: 3, bore: 1.16, flare: 0.5, wastegate: 2, wrap: 0 }, visualTier: 2 },
        ...
        { id: "sig_mercedes_exh", label: "Brackley Exhaust", cost: 60, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "free_flow",
          desc: "Mercedes signature exhaust — Free Flow performance with a flared megaphone tip", speed: 1.03, accel: 1.03, visual: { pipes: 1, bore: 1.121, flare: 0.5, wastegate: 0, wrap: 0 }, visualTier: 1 },
        { id: "sig_ferrari_exh", label: "Maranello Exhaust", cost: 170, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "tri_exit",
          desc: "Ferrari signature exhaust — Tri-Exit performance with a three-pipe exit", speed: 1.04, accel: 1.07, visual: { pipes: 3, bore: 1.206, flare: 1, wastegate: 2, wrap: 1 }, visualTier: 2 },
        { id: "sig_mclaren_exh", label: "Woking Exhaust", cost: 140, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "inconel",
          desc: "McLaren signature exhaust — Inconel Race performance with a three-pipe exit", speed: 1.04, accel: 1.05, visual: { pipes: 3, bore: 1.029, flare: 0.5, wastegate: 2, wrap: 0 }, visualTier: 2 },
        { id: "sig_redbull_exh", label: "Milton Keynes Exhaust", cost: 110, teams: ["redbull"], tag: "SIGNATURE", equivalent: "twin_gate",
          desc: "Red Bull signature exhaust — Twin Wastegate performance with a three-pipe exit", speed: 1.01, accel: 1.07, visual: { pipes: 3, bore: 1.122, flare: 1, wastegate: 0, wrap: 0 }, visualTier: 2 },
        { id: "sig_alpine_exh", label: "Enstone Exhaust", cost: 30, teams: ["alpine"], tag: "SIGNATURE", equivalent: "sport_cat",
          desc: "Alpine signature exhaust — Sport Cat performance with a flared megaphone tip", accel: 1.03, visual: { pipes: 1, bore: 1.091, flare: 0.5, wastegate: 2, wrap: 1 }, visualTier: 1 },
        { id: "sig_racingbulls_exh", label: "Faenza Exhaust", cost: 60, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "free_flow",
          desc: "Racing Bulls signature exhaust — Free Flow performance with a single tuned pipe", speed: 1.03, accel: 1.03, visual: { pipes: 1, bore: 1.145, flare: 0, wastegate: 0, wrap: 0 }, visualTier: 1 },
        { id: "sig_haas_exh", label: "Kannapolis Exhaust", cost: 0, teams: ["haas"], tag: "SIGNATURE", equivalent: "stock",
          desc: "Haas signature exhaust — Stock performance with a single tuned pipe", visual: { pipes: 1, bore: 1.05, flare: 0, wastegate: 0, wrap: 1 }, visualTier: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "sealed_edge", label: "Sealed Edge",    cost:  50, desc: "Sealed floor edge — steadier underbody load through medium-speed corners",     speed: 0.99, cornering: 1.06, visual: { fences: 4, fenceH: 1.15, skid: 0, edgeLip: 0.5 }, visualTier: 1 },
        ...
        { id: "fence_array", label: "Fence Array",    cost:  90, desc: "Full fence array — keeps the floor sealed when the car is yawed",              speed: 0.98, cornering: 1.10, visual: { fences: 6, fenceH: 1.3, skid: 0, edgeLip: 0.3 }, visualTier: 2 },
        { id: "edge_wing",   label: "Edge Wing",      cost: 120, desc: "Floor-edge wing — extra load for a modest drag penalty",                       speed: 0.98, cornering: 1.13, braking: 1.02, visual: { fences: 5, fenceH: 1.2, skid: 1, edgeLip: 1 }, visualTier: 2 },
        { id: "venturi",     label: "Venturi Floor",  cost: 190, desc: "Full venturi package — maximum underbody load at every speed",                 speed: 0.96, cornering: 1.16, braking: 1.04, visual: { fences: 6, fenceH: 1.45, skid: 2, edgeLip: 1 }, visualTier: 2 },
        ...
        { id: "sig_mercedes_floor", label: "Brackley Floor", cost: 120, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "edge_wing",
          desc: "Mercedes signature floor — Edge Wing performance with a 5-fence floor edge on titanium skids", speed: 0.98, cornering: 1.13, braking: 1.02, visual: { fences: 5, fenceH: 1.164, skid: 1, edgeLip: 1 }, visualTier: 2 },
        { id: "sig_ferrari_floor", label: "Maranello Floor", cost: 190, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "venturi",
          desc: "Ferrari signature floor — Venturi Floor performance with a 6-fence floor edge on titanium skids", speed: 0.96, cornering: 1.16, braking: 1.04, visual: { fences: 6, fenceH: 1.523, skid: 2, edgeLip: 1 }, visualTier: 2 },
        { id: "sig_mclaren_floor", label: "Woking Floor", cost: 190, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "venturi",
          desc: "McLaren signature floor — Venturi Floor performance with a 6-fence floor edge on titanium skids", speed: 0.96, cornering: 1.16, braking: 1.04, visual: { fences: 6, fenceH: 1.378, skid: 1, edgeLip: 1 }, visualTier: 2 },
        { id: "sig_redbull_floor", label: "Milton Keynes Floor", cost: 90, teams: ["redbull"], tag: "SIGNATURE", equivalent: "fence_array",
          desc: "Red Bull signature floor — Fence Array performance with a 6-fence floor edge on titanium skids", speed: 0.98, cornering: 1.1, visual: { fences: 6, fenceH: 1.391, skid: 2, edgeLip: 0.55 }, visualTier: 2 },
        { id: "sig_alpine_floor", label: "Enstone Floor", cost: 50, teams: ["alpine"], tag: "SIGNATURE", equivalent: "sealed_edge",
          desc: "Alpine signature floor — Sealed Edge performance with a 4-fence floor edge on titanium skids", speed: 0.99, cornering: 1.06, visual: { fences: 4, fenceH: 1.173, skid: 1, edgeLip: 0.5 }, visualTier: 1 },
        { id: "sig_racingbulls_floor", label: "Faenza Floor", cost: 60, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "ti_skids",
          desc: "Racing Bulls signature floor — Titanium Skids performance with a 5-fence floor edge", cornering: 1.04, braking: 1.04, visual: { fences: 5, fenceH: 0.98, skid: 0, edgeLip: 0 }, visualTier: 1 },
        { id: "sig_haas_floor", label: "Kannapolis Floor", cost: 0, teams: ["haas"], tag: "SIGNATURE", equivalent: "stripped",
          desc: "Haas signature floor — Stripped performance with bare titanium skids and no fences", speed: 1.04, cornering: 0.9, visual: { fences: 0, fenceH: 1.04, skid: 2, edgeLip: 0 }, visualTier: 0 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "faired_halo",label: "Faired Halo",   cost:  40, desc: "Aero fairing over the halo — cleans up the flow to the airbox",              speed: 1.02, visual: { haloBlade: 1, haloWing: 0, camPods: 0, screen: 0 }, visualTier: 1 },
        { id: "twin_cam",   label: "Twin T-Cam",    cost:  30, desc: "Second camera pod — broadcast spec, and a touch more roll-hoop drag",        speed: 0.99, cornering: 1.02, visual: { haloBlade: 0, haloWing: 0, camPods: 2, screen: 0 }, visualTier: 1 },
        ...
        { id: "sig_mercedes_cpit", label: "Brackley Cockpit", cost: 110, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "halo_wing",
          desc: "Mercedes signature cockpit — Halo Wing performance with a bladed halo", speed: 0.99, cornering: 1.07, visual: { haloBlade: 1, haloWing: 0, camPods: 1, screen: 1 }, visualTier: 2 },
        { id: "sig_ferrari_cpit", label: "Maranello Cockpit", cost: 160, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "full_shroud",
          desc: "Ferrari signature cockpit — Full Shroud performance with a fully faired halo and an upper flap", speed: 1.01, cornering: 1.08, braking: 1.02, visual: { haloBlade: 2, haloWing: 1, camPods: 2, screen: 0 }, visualTier: 2 },
        { id: "sig_mclaren_cpit", label: "Woking Cockpit", cost: 110, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "halo_wing",
          desc: "McLaren signature cockpit — Halo Wing performance with a bladed halo and an upper flap", speed: 0.99, cornering: 1.07, visual: { haloBlade: 1, haloWing: 1, camPods: 2, screen: 1 }, visualTier: 2 },
        { id: "sig_redbull_cpit", label: "Milton Keynes Cockpit", cost: 60, teams: ["redbull"], tag: "SIGNATURE", equivalent: "deflector",
          desc: "Red Bull signature cockpit — Deflector performance with a fully faired halo", speed: 1.03, braking: 1.02, visual: { haloBlade: 2, haloWing: 0, camPods: 2, screen: 0 }, visualTier: 2 },
        { id: "sig_alpine_cpit", label: "Enstone Cockpit", cost: 40, teams: ["alpine"], tag: "SIGNATURE", equivalent: "faired_halo",
          desc: "Alpine signature cockpit — Faired Halo performance with a bladed halo and an upper flap", speed: 1.02, visual: { haloBlade: 1, haloWing: 1, camPods: 1, screen: 0 }, visualTier: 1 },
        { id: "sig_racingbulls_cpit", label: "Faenza Cockpit", cost: 30, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "twin_cam",
          desc: "Racing Bulls signature cockpit — Twin T-Cam performance with a bare halo", speed: 0.99, cornering: 1.02, visual: { haloBlade: 0, haloWing: 0, camPods: 1, screen: 1 }, visualTier: 1 },
        { id: "sig_haas_cpit", label: "Kannapolis Cockpit", cost: 0, teams: ["haas"], tag: "SIGNATURE", equivalent: "standard",
          desc: "Haas signature cockpit — Standard performance with a bare halo", visual: { haloBlade: 0, haloWing: 0, camPods: 0, screen: 0 }, visualTier: 1 },
        { id: "sig_williams_cpit", label: "Grove Cockpit", cost: 40, teams: ["williams"], tag: "SIGNATURE", equivalent: "faired_halo",
          desc: "Williams signature cockpit — Faired Halo performance with a bare halo", speed: 1.02, visual: { haloBlade: 0, haloWing: 0, camPods: 0, screen: 1 }, visualTier: 1 },
        { id: "sig_audi_cpit", label: "Neuburg Cockpit", cost: 60, teams: ["audi"], tag: "SIGNATURE", equivalent: "deflector",
          desc: "Audi signature cockpit — Deflector performance with a fully faired halo and an upper flap", speed: 1.03, braking: 1.02, visual: { haloBlade: 2, haloWing: 1, camPods: 2, screen: 0 }, visualTier: 2 },
        { id: "sig_astonmartin_cpit", label: "Silverstone Cockpit", cost: 160, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "full_shroud",
          desc: "Aston Martin signature cockpit — Full Shroud performance with a fully faired halo and an upper flap", speed: 1.01, cornering: 1.08, braking: 1.02, visual: { haloBlade: 2, haloWing: 1, camPods: 2, screen: 1 }, visualTier: 2 },
        { id: "sig_cadillac_cpit", label: "Detroit Cockpit", cost: 30, teams: ["cadillac"], tag: "SIGNATURE", equivalent: "twin_cam",
          desc: "Cadillac signature cockpit — Twin T-Cam performance with a bladed halo", speed: 0.99, cornering: 1.02, visual: { haloBlade: 1, haloWing: 0, camPods: 0, screen: 0 }, visualTier: 1 },
      ],
    },
  ];
  ...
  const VISUAL_FIELD_REGISTRY = Object.freeze({
    geometry: Object.freeze({
      ...
      suspension: Object.freeze(["ride", "arm", "push", "pull", "wishbone", "toe", "rocker"]),
      brakes: Object.freeze(["duct", "caliperPos", "coverOpen", "rotor", "rotorScale", "scoop", "discFace"]),
      tyres: Object.freeze(["grooved", "grooves", "grooveDepth", "bandWidth", "coverVanes", "shoulder"]),
