...
const Parts = (function () {
  ...
  const CATALOG = [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "full_attack",    label: "Full Attack",   cost: 200, desc: "Maximum ERS output — qualifying/sprint spec",                               speed: 1.06, accel: 1.14, visual: {"led": [2.25, 0.22, 0.16], "pack": 1.3, blister: 1}, visualTier: 2 },
        { id: "overcharge",     label: "Overcharge",    cost: 230, desc: "Experimental limit-push mode — maximum all-channel ERS output",              speed: 1.10, accel: 1.18, visual: {"led": [2.4, 0.75, 0.06], "pack": 1.35, blister: 1}, visualTier: 2 },
        { id: "supercapacitor", label: "Supercapacitor", cost: 180, desc: "High-discharge buffer — immediate deployment with improved recovery",        speed: 1.04, accel: 1.13, braking: 1.04, visual: { led: [0.30, 2.20, 2.20], pack: 1.10 , blister: 2}, visualTier: 2 },
        // External-conduit packages — visible high-voltage plumbing on the cover.
        { id: "harvest_max",    label: "Harvest Max",   cost:  95, desc: "Maximum recovery window — tops the pack up everywhere without hurting pace",   speed: 1.01, braking: 1.08, accel: 1.02, visual: { led: [0.20, 1.60, 0.85], pack: 1.05, cells: 4, conduit: 1 , blister: 2}, visualTier: 1 },
        ...
        { id: "sig_ferrari_ers", label: "Maranello Deploy Map", cost: 120, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "torque_fill",
          desc: "Ferrari signature deploy map — Torque Fill performance with a twin external conduit", accel: 1.08, cornering: 1.06, visual: { led: [2.1, 0.2, 0.12], pack: 1.196, cells: 7, conduit: 2 , blister: 1}, visualTier: 2 },
        { id: "sig_mclaren_ers", label: "Woking Deploy Map", cost: 180, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "supercapacitor",
          desc: "McLaren signature deploy map — Supercapacitor performance with a twin external conduit", speed: 1.04, accel: 1.13, braking: 1.04, visual: { led: [2.2, 1.05, 0.05], pack: 1.078, cells: 6, conduit: 2 , blister: 1}, visualTier: 2 },
        { id: "sig_redbull_ers", label: "Milton Keynes Deploy Map", cost: 130, teams: ["redbull"], tag: "SIGNATURE", equivalent: "overtake_focus",
          desc: "Red Bull signature deploy map — OT Focus performance with an external conduit run", speed: 0.96, accel: 1.12, cornering: 1.04, visual: { led: [2.15, 1.7, 0.1], pack: 1.224, cells: 4, conduit: 1 , blister: 1}, visualTier: 2 },
        { id: "sig_racingbulls_ers", label: "Faenza Deploy Map", cost: 90, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "split_deploy",
          desc: "Racing Bulls signature deploy map — Split Deploy performance with an external conduit run", accel: 1.06, cornering: 1.04, visual: { led: [0.35, 0.6, 2.25], pack: 1.067, cells: 5, conduit: 1 , blister: 1}, visualTier: 1 },
        { id: "sig_haas_ers", label: "Kannapolis Deploy Map", cost: 60, teams: ["haas"], tag: "SIGNATURE", equivalent: "harvest",
          desc: "Haas signature deploy map — Harvest performance with an external conduit run", speed: 1.02, accel: 0.95, visual: { led: [1.8, 1.8, 1.95], pack: 0.997, cells: 3, conduit: 1 , blister: 2}, visualTier: 0 },
        { id: "sig_williams_ers", label: "Grove Deploy Map", cost: 110, teams: ["williams"], tag: "SIGNATURE", equivalent: "thermal_max",
          desc: "Williams signature deploy map — Thermal Max performance with an external conduit run", speed: 1.04, braking: 1.03, visual: { led: [0.25, 1.15, 2.2], pack: 0.976, cells: 4, conduit: 1 , blister: 2}, visualTier: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "quali_mix",     label: "Qualifying Mix", cost: 150, desc: "Maximum energy density — qualifying-spec fuel load for peak performance",    speed: 1.04, accel: 1.08, visual: {"cap": [0.95, 0.28, 1.5], "flame": [1.25, 0.35, 1.75], "fxFlame": [1.5, 1.7, 2.4], hatch: 1}, visualTier: 2 },
        { id: "custom_formula",label: "Custom Formula", cost: 200, desc: "Team-developed proprietary blend — marginal all-metric gains",               speed: 1.05, accel: 1.09, cornering: 1.02, braking: 1.02, visual: {"cap": [1.9, 0.25, 1.25], "flame": [1.85, 0.25, 1.4], "fxFlame": [2.6, 0.5, 2.1], vent: 1}, visualTier: 2 },
        ...
        { id: "cold_blend",    label: "Cold Blend",     cost: 120, desc: "Chilled high-density charge — cleaner combustion and a broader torque plateau", speed: 1.03, accel: 1.06, visual: { cap: [0.30, 0.80, 1.60], flame: [0.55, 0.95, 1.85], fxFlame: [1.1, 1.6, 2.7], line: 1, filler: 1 , hatch: 1}, visualTier: 1 },
        ...
        { id: "sig_ferrari_fuel", label: "Maranello Blend", cost: 90, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "race_blend",
          desc: "Ferrari signature blend — Race Blend performance with twin filler couplings", speed: 1.02, accel: 1.06, visual: { cap: [1.52, 0.08, 0.064], flame: [1.9, 0.3, 0.15], fxFlame: [2.85, 0.45, 0.225], filler: 2, line: 2 , vent: 1}, visualTier: 1 },
        { id: "sig_mclaren_fuel", label: "Woking Blend", cost: 175, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "efuel_dense",
          desc: "McLaren signature blend — Dense E-Fuel performance with a quick-fill coupling", speed: 1.045, accel: 1.085, braking: 1.01, visual: { cap: [1.6, 0.8, 0], flame: [1.95, 0.95, 0.1], fxFlame: [2.925, 1.425, 0.15], filler: 1, line: 2 , hatch: 1}, visualTier: 2 },
        ...
        { id: "sig_racingbulls_fuel", label: "Faenza Blend", cost: 40, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "high_octane",
          desc: "Racing Bulls signature blend — High Octane performance with a quick-fill coupling", accel: 1.05, visual: { cap: [0.32, 0.48, 1.52], flame: [0.45, 0.6, 1.95], fxFlame: [0.675, 0.9, 2.925], filler: 1, line: 1 , hatch: 1}, visualTier: 1 },
        ...
        { id: "sig_cadillac_fuel", label: "Detroit Blend", cost: 175, teams: ["cadillac"], tag: "SIGNATURE", equivalent: "efuel_dense",
          desc: "Cadillac signature blend — Dense E-Fuel performance with twin filler couplings", speed: 1.045, accel: 1.085, braking: 1.01, visual: { cap: [1.36, 1.12, 0.512], flame: [1.8, 1.35, 0.5], fxFlame: [2.7, 2.025, 0.75], filler: 2, line: 1 , lip: 1}, visualTier: 2 },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { id: "sig_ferrari_rim", label: "Maranello Rim", cost: 170, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "works_rim",
          desc: "Ferrari signature rim — Works Rim performance with a plain rim with a banded shoulder", speed: 1.03, accel: 1.04, cornering: 1.04, braking: 1.04, visual: { spokes: 0, tape: 1, dish: 2, nut: [0.95, 0.05, 0.04] , gunNut: 1}, visualTier: 2 },
        { id: "sig_mclaren_rim", label: "Woking Rim", cost: 170, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "works_rim",
          desc: "McLaren signature rim — Works Rim performance with a 8-spoke rim with a banded shoulder", speed: 1.03, accel: 1.04, cornering: 1.04, braking: 1.04, visual: { spokes: 8, tape: 1, dish: 1, nut: [1, 0.5, 0] , gunNut: 1}, visualTier: 2 },
        { id: "sig_redbull_rim", label: "Milton Keynes Rim", cost: 40, teams: ["redbull"], tag: "SIGNATURE", equivalent: "spoked",
          desc: "Red Bull signature rim — Spoked Rim performance with a 5-spoke rim with a banded shoulder", braking: 1.04, visual: { spokes: 5, tape: 1, dish: 2, nut: [0.95, 0.78, 0] , gunNut: 1}, visualTier: 1 },
        { id: "sig_alpine_rim", label: "Enstone Rim", cost: 50, teams: ["alpine"], tag: "SIGNATURE", equivalent: "taped",
          desc: "Alpine signature rim — Taped Rim performance with a 4-spoke rim with a banded shoulder", cornering: 1.04, visual: { spokes: 4, tape: 1, dish: 1, nut: [1, 0.53, 0.74] , gunNut: 1}, visualTier: 1 },
        { id: "sig_racingbulls_rim", label: "Faenza Rim", cost: 60, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "dished",
          desc: "Racing Bulls signature rim — Dished Cover performance with a 6-spoke rim", speed: 1.03, visual: { spokes: 6, tape: 0, dish: 0, nut: [0.2, 0.3, 0.95] , gunNut: 1}, visualTier: 1 },
  ...
  const VISUAL_FIELD_REGISTRY = Object.freeze({
    geometry: Object.freeze({
      ...
      wheels: Object.freeze(["spokes", "tape", "dish", "gunNut"]),
    }),
