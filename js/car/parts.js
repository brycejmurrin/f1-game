    ...
    },
    {
      ...
      options: [
        ...
        { id: "sig_cadillac_sprint", label: "Cadillac Sprint", cost: 135, teams: ["cadillac"], tag: "SIGNATURE", equivalent: "sprint_soft",
          desc: "Cadillac signature sprint compound — Sprint Soft performance with a gold double-width band", speed: 0.93, accel: 1.08, cornering: 1.22, braking: 1.09, visual: {sidewall: 2, band: [0.92, 0.72, 0.18], grooves: 0, bandWidth: 0.125, coverVanes: 4, shoulder: 2}, visualTier: 2 },
        { id: "sig_rb_street", label: "Faenza Street", cost: 125, teams: ["racingbulls"], tag: "SIGNATURE", equivalent: "supersoft",
          desc: "Racing Bulls signature street compound — Super Soft performance with a twin-blue sidewall band", speed: 0.94, accel: 1.06, cornering: 1.20, braking: 1.10, visual: {sidewall: 1, band: [0.2, 0.3, 0.95], grooves: 0, bandWidth: 0.135, coverVanes: 7, shoulder: 1}, visualTier: 2 },
        { id: "sig_mercedes_tyre", label: "Brackley Compound", cost: 0, teams: ["mercedes"], tag: "SIGNATURE", equivalent: "medium",
          desc: "Mercedes signature compound — Medium performance with a 10-vane wheel cover", speed: 1.00, accel: 1.00, cornering: 1.00, visual: {sidewall: 2, band: [0, 0.72, 0.68], grooves: 0, bandWidth: 0.088, coverVanes: 10, shoulder: 2}, visualTier: 1 },
        { id: "sig_ferrari_tyre", label: "Maranello Compound", cost: 80, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Ferrari signature compound — Soft performance with a 6-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, braking: 1.06, visual: {sidewall: 1, band: [0.98, 0.78, 0.06], grooves: 0, bandWidth: 0.125, coverVanes: 5, shoulder: 1}, visualTier: 2 },
        { id: "sig_mclaren_tyre", label: "Woking Compound", cost: 135, teams: ["mclaren"], tag: "SIGNATURE", equivalent: "sprint_soft",
          desc: "McLaren signature compound — Sprint Soft performance with a 11-vane wheel cover", speed: 0.93, accel: 1.08, cornering: 1.22, braking: 1.09, visual: {sidewall: 2, band: [1, 0.47, 0], grooves: 0, bandWidth: 0.118, coverVanes: 12, shoulder: 1}, visualTier: 2 },
        { id: "sig_redbull_tyre", label: "Milton Keynes Compound", cost: 80, teams: ["redbull"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Red Bull signature compound — Soft performance with a 8-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, braking: 1.06, visual: {sidewall: 2, band: [0.1, 0.2, 0.72], grooves: 0, bandWidth: 0.115, coverVanes: 7, shoulder: 2}, visualTier: 2 },
        { id: "sig_alpine_tyre", label: "Enstone Compound", cost: 55, teams: ["alpine"], tag: "SIGNATURE", equivalent: "compound_c4",
          desc: "Alpine signature compound — Compound C4 performance with a 7-vane wheel cover", speed: 0.98, accel: 1.02, cornering: 1.08, braking: 1.06, visual: {sidewall: 1, band: [1, 0.53, 0.74], grooves: 1, bandWidth: 0.128, coverVanes: 10, shoulder: 1, grooveDepth: 0.05}, visualTier: 2 },
        { id: "sig_haas_tyre", label: "Kannapolis Compound", cost: 0, teams: ["haas"], tag: "SIGNATURE", equivalent: "hard",
          desc: "Haas signature compound — Hard performance with a 5-vane wheel cover", speed: 1.02, accel: 0.97, cornering: 0.92, braking: 1.02, visual: {sidewall: 2, band: [0.86, 0.16, 0.11], grooves: 0, bandWidth: 0.095, coverVanes: 8, shoulder: 1}, visualTier: 0 },
        { id: "sig_williams_tyre", label: "Grove Compound", cost: 0, teams: ["williams"], tag: "SIGNATURE", equivalent: "hard",
          desc: "Williams signature compound — Hard performance with a 12-vane wheel cover", speed: 1.02, accel: 0.97, cornering: 0.92, braking: 1.02, visual: {sidewall: 2, band: [0.15, 0.42, 0.95], grooves: 0, bandWidth: 0.082, coverVanes: 6, shoulder: 2}, visualTier: 0 },
        { id: "sig_audi_tyre", label: "Neuburg Compound", cost: 55, teams: ["audi"], tag: "SIGNATURE", equivalent: "compound_c4",
          desc: "Audi signature compound — Compound C4 performance with a 4-vane wheel cover", speed: 0.98, accel: 1.02, cornering: 1.08, braking: 1.06, visual: {sidewall: 1, band: [0.75, 0.1, 0.3], grooves: 0, bandWidth: 0.135, coverVanes: 11, shoulder: 1}, visualTier: 2 },
        { id: "sig_astonmartin_tyre", label: "Silverstone Compound", cost: 80, teams: ["astonmartin"], tag: "SIGNATURE", equivalent: "soft",
          desc: "Aston Martin signature compound — Soft performance with a 3-vane wheel cover", speed: 0.97, accel: 1.04, cornering: 1.12, braking: 1.06, visual: {sidewall: 2, band: [0.72, 0.88, 0.11], grooves: 0, bandWidth: 0.072, coverVanes: 4, shoulder: 2}, visualTier: 2 },
      ],
    },
    {
      id: "ers", label: "ERS",
