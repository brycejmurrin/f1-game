  ...
  const CATALOG = [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "reg26_concept", label: "2026 Concept", cost: 185, desc: "Full 2026 body kit — scooped duct, wakeboard and floor-corner slots on a high-DF stack", speed: 0.93, cornering: 1.24, braking: 1.08, visual: { lvl: 3.4, beam: 1, vane: 2, plate: 3, casc: 2, swan: 1, tvane: 1, duct: 2, board: 2, slot: 1, frontSweep: 0.10, frontTaper: 0.88, frontRise: 0.11, rearSweep: 0.10, rearTaper: 0.88, floorEdge: 1.20, floorCut: 0.16, diffuserRise: 1.26 }, visualTier: 2 },
        ...
        { id: "sig_ferrari_wing", label: "Maranello Aero Kit", cost: 190, teams: ["ferrari"], tag: "SIGNATURE", equivalent: "circuit_adaptive",
          desc: "Ferrari signature aero kit — Circuit Adaptive performance with a full wakeboard and floor-corner slots", speed: 1.01, cornering: 1.22, braking: 1.06, visual: { lvl: 3.6, beam: 1, drs: 1, vane: 3, frontSweep: 0.124, frontTaper: 0.845, frontRise: 0.12, rearSweep: 0.138, rearTaper: 0.835, floorEdge: 1.206, floorCut: 0.15, diffuserRise: 1.293, plate: 3, casc: 3, swan: 0, tvane: 1, duct: 0, board: 2, slot: 1 }, visualTier: 2 },
