...
const LIV_ROW_HINT = {
  ...
  spineTint: "SPINE TINT — SPINE TOP band on the cover crown + saddle flank half. Unset = ACCENT, contrast-checked vs ENGINE COVER.",
  sideTint: "SIDE TINT — SPINE SIDE band designs (SPLIT, BARS, SLASH, …) on the cover flank. Unset = ACCENT vs the flank — never inherits SPINE TINT.",
  sunTint: "SUN — WRAP sun disc (crown, flanks, airbox). Unset = mark plate / ACCENT / PRIMARY vs ENGINE COVER — never inherits SPINE TINT.",
  crestInk: "CREST INK — crown lettering (wordmark, number, carbon keylines, flank marks). Unset = auto ink vs ENGINE COVER.",
  bandTint2: "2ND BAND — TRICOLOUR's second band. Unset = derived vs cover and first band.",
  plateTint: "PLATE PANEL — board under SPINE SIDE PLATE number. Unset = ACCENT / PRIMARY vs the flank.",
  plateInk: "PLATE NUMBER — the number ON that board. Unset = PRIMARY where it reads, else auto ink.",
  wing: "WINGS — front and rear FLAPS. Unset = ACCENT.",
