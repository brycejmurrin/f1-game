/* Apex 26 — procedural scenery: primitive emitters (box/cyl/cone/frustum/
 * prism/pyramid/mountain), the on-track-rejection scenery API wrapper, and
 * buildProps() — per-circuit dressing (city generator, furniture, barriers,
 * glass/water meshes, terrain raycast grid). Extends TracksKit (needs
 * tracks-spline.js + tracks-mesh.js loaded first). See docs/SCENERY-API.md. */
"use strict";

(function () {
"use strict";
const { cross, norm, lerp, upOf, hash, findCorners } = TracksKit;
...
Object.assign(TracksKit, {
  ...
  emit, vadd, reverseSceneryApi, buildProps,
});
})();
