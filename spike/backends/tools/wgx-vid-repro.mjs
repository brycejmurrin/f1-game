...
// lifting that workaround (spike/backends/docs/WEBGPU-PARITY.md §road items).
//
//   node spike/backends/tools/wgx-vid-repro.mjs [--stack swiftshader|lavapipe|both] [--json]
//
