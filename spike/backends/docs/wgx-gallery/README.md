...
Committed captures from `node spike/backends/tools/wgx-shot.mjs --gallery --lite` (or
...
Regenerate: `npm run wgx:gallery` or `node spike/backends/tools/wgx-shot.mjs --gallery --lite`.
