 ...
 * vec3<f32>, @builtin(vertex_index). See spike/backends/docs/WEBGPU-PARITY.md.
 *
...
struct DrawU {
  ...
  lampRange : vec4<f32>,      // off 128 (chunkLampIdx offset, count, per-chunk-active flag, pad)
};                            // size 144
