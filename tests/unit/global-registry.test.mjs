...
const KNOWN_EXTERNAL_READS = {
  ...
  "js/game/menus.js": ["__APEX_BUILD__"],        // exportRecovery stamps the shell build id
  ...
  "js/game/menus.js": ["__APEX_BUILD__"],        // build stamp for export recovery (index.html meta)
