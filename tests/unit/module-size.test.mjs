...
const CEILINGS = {
  ...
  "js/track/tracks.js": 2973, // 2933 -> 2973: roadHwFeel class ladder next to applyHwZones (city streets lift more than wide permanents; Miami stays authored). Not a new engine file — the scale is consumed only when LIST points materialize.
};
