...
const CEILINGS = {
  ...
  // Both are one-line edits; the growth is the comments recording the
  // measurement and why the null is unobservable — the bug-explaining growth
  // the note above tolerates, not a feature.
  "js/game.js": 8033,
