...
const CEILINGS = {
  ...
  "js/game/apex.js": 2595,   // +5: garageCam reports effDist/fitD/panelFrac — the auto path is the one that can misframe, and the hook reported a distance the camera does not use
