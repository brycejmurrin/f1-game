 ...
 *      Same idiom as tests/module-size.test.mjs and tools/clip-baseline.json.
 *
 * Run: node --test tests/comment-citations.test.mjs   (npm run test:tooling-fast)
 */
...
// second assertion tests/module-size.test.mjs carries, for the same reason.
