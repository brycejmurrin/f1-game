...
test("declaredTests counts by AST, and rejects nothing silently", () => {
  assert.equal(declaredTests("tests/physics-characterization.spec.js"), 1);
  assert.equal(declaredTests("tests/smoke.spec.js"), 9);
  assert.equal(declaredTests("tests/there-is-no-such.spec.js"), null,
