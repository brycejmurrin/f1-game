 ...
 * tests/multiplayer-session.spec.js already does exactly that.
 *
 ...
 *
 * Run: node --test tests/race-control.test.mjs   (npm run test:tooling-fast)
 */
...
// evaluating its name. Same shape as tests/agentview-api-contract.test.mjs.
