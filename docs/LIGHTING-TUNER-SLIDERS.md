# LIGHTING TUNER — the 184 sliders, and what each one drives
...
<!-- GENERATED: tune-defs -->
_Generated by `node tools/gen/gen-slider-doc.mjs` from `TUNE_DEFS` in `js/lighting/knobs.js` — 184 sliders in 11 groups. Do not edit the tables by hand; `--check` guards them (`tests/unit/generated-docs.test.mjs`)._
