...
<!-- GENERATED: tune-defs -->
_Generated by `node tools/gen-slider-doc.mjs` from `TUNE_DEFS` in `js/game/lighting.js` — 183 sliders in 11 groups. Do not edit the tables by hand; `--check` guards them (`tests/unit/generated-docs.test.mjs`)._
...
| `moonShadow` | MOON SHADOWS | 0 … 1 | 0.25 | — |   | game.js×6, glx.js×2 |
| `carShadow` | CAR SUN SHADOWS | 0 … 1 | 1 | — |   | game.js |
| `lampShadow` | LAMP SHADOWS | 0 … 1 | 1 | — |   | game.js |
...
| `lampDensity` | LAMP DENSITY | 0.1 … 2.35 | 1 | — |   | lighting.js×2, tracks.js×3 |
| `floodDay` | DAYTIME LAMPS | 0 … 4.5 | 0 | — |   | game.js×3 |
| `poolEnergy` | POOL ENERGY | 0 … 1.375 | 0.55 | — | ✓ | lighting.js×3 |
| `lampRadiusMul` | POOL RADIUS | 0.4 … 1.9 | 1 | — | ✓ | lighting.js×3 |
| `bleedMul` | VALLEY BLEED | 0 … 2.5 | 1 | — | ✓ | lighting.js×3 |
| `glareStr` | LENS GLARE | 0 … 0.3 | 0.12 | — | ✓ | game.js×4, garage-scene.js |
| `lampTemp` | LAMP TEMPERATURE | -3.3 … 8.3 | 0 | — | ✓ | game.js |
| `lampFlicker` | LAMP FLICKER | 0 … 0.6 | 0.1 | — | ✓ | lighting.js |
| `beamCone` | BEAM CONE WIDTH | 0.08 … 2.2 | 1 | — | ✓ | lighting.js×3 |
...
| `lampWarmup` | LAMP WARM-UP | 0 … 2.5 | 1 | — | ✓ | lighting.js×2 |
| `lampWarmupDim` | WARM-UP DIP | 0 … 0.9 | 0.3 | — |   | lighting.js×2 |
| `lampWarmupWarm` | WARM-UP WARMTH | 0 … 2.5 | 1 | — |   | lighting.js×2 |
| `lampCull` | LAMP COUNT | 16 … 48 | 40 | — |   | apex.js, lighting.js×3 |
| `lampCullFade` | LAMP CULL FADE | 0.02 … 0.9 | 0.35 | — | ✓ | lighting.js×2 |
| `lampGapFill` | DARK-GAP FILL | 0 … 150 | 60 | — |   | lighting.js×2 |
| `lampBehindBias` | BEHIND-CAM BIAS | 0.2 … 8 | 5.25 | — |   | lighting.js×3 |
| `roadChunkLamps` | PER-CHUNK ROAD | 0 … 1 | 0 | — | ✓ | game.js×5, apex.js, chunked.js |
| `perChunkLights` | PER-CHUNK LAMPS | 0 … 1 | 0 | — | ✓ | game.js×7, apex.js×3, lighting.js×2, tuner.js, glx.js, chunked.js×2 |
| `lampReach` | LAMP REACH AHEAD | 1 … 4 | 1 | — |   | lighting.js×2 |
...
| `tailLightMul` | TAIL-LIGHT GLOW | 0 … 2.5 | 1 | — |   | lighting.js |
| `brakeGlowMul` | BRAKE FLARE | 0 … 2.5 | 1 | — |   | lighting.js |
| `tailRange` | TAIL-LIGHT RANGE | 60 … 310 | 160 | — |   | lighting.js×2 |
| `tailFade` | TAIL-LIGHT FADE | 0 … 60 | 0 | — | ✓ | lighting.js×2 |
...
| `tint` | WARM / COOL | -6 … 6 | 0 | `uTint` | ✓ | lighting.js×2, gltf.js, post.js×2, geom.js, tracks.js |
