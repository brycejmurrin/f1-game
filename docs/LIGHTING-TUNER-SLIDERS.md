...
once per condition, not once per slider. Documented specials: `fogWxMul` →
fog, `overcastFogMul` → overcast, `drizzle*` → wet (not rain), `moonShadow` →
night+wet, `renderDistMul` → Spa day 0.50 chase, `starBright` → Bahrain night
sky, `lampCull`/`tailLightMul` → Singapore night + traffic. Pixel MAD is still
...
|---|---|---|---|---|---|---|
| `keyMul` | KEY LIGHT (SUN) | 0 … 6 | 1 | `uKeyMul` | ✓ | glx.js×6, lit.js |
| `sunTemp` | SUN / MOON WARMTH | -3 … 3 | 0 | — | ✓ | atmosphere.js×2, light-store.js |
| `sunElev` | SUN ELEVATION | -90 … 90 | 0 | — | ✓ | atmosphere.js×4, light-store.js |
| `sunAzim` | SUN AZIMUTH | -180 … 180 | 0 | — |  | atmosphere.js×4, light-store.js |
| `moonBright` | MOON BRIGHTNESS | 0 … 4.5 | 1 | — | ✓ | atmosphere.js, light-store.js, game.js×2 |
| `grMul` | SUN GOD-RAYS | 0 … 6 | 1 | — | ✓ | game.js×2 |
| `godrayAniso` | GOD-RAY FOCUS | 0 … 0.95 | 0.6 | `uHgAniso` |  | post.js×2 |
| `godrayFloor` | GOD-RAY HAZE | 0 … 0.2 | 0.02 | `uHgFloor` |  | post.js×2 |
| `godrayLowBoost` | GOD-RAY LOW-SUN DRAMA | 0 … 3 | 0.55 | — |  | game.js×2 |
| `godrayBase` | GOD-RAY BASE | 0 … 2.25 | 0.38 | — |  | game.js×2 |
| `sunShaftMul` | SCREEN SUN-SHAFT | 0 … 6 | 1 | — |  | post.js×4 |
...
| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `ambientMul` | AMBIENT FILL | 0 … 6 | 1 | — | ✓ | glx.js×2 |
| `ambTemp` | AMBIENT WARMTH | -3 … 3 | 0 | — | ✓ | atmosphere.js×2, light-store.js |
| `ambBalance` | SKY / GROUND FILL | -3 … 3 | 0 | — | ✓ | atmosphere.js×2, light-store.js |
| `nightAmbLift` | NIGHT AMBIENT | 0 … 6 | 1 | — |  | game.js×2 |
...
| `shadowRange` | SHADOW DISTANCE | 16 … 450 | 80 | `uShadowRange` |  | game.js, glx.js×2, lit.js |
| `pcssPen` | SHADOW SOFTEN | 5 … 750 | 80 | `uPcssPen` | ✓ | glx.js×2 |
| `shadowBias` | SHADOW BIAS | 0 … 0.01 | 0.001 | `uShadowBias` |  | glx.js×2 |
| `shadowTintAmt` | SHADOW COOLNESS | 0 … 2.25 | 0 | `uShadowTintAmt` | ✓ | glx.js×2 |
...
| `aoStr` | AMBIENT OCCLUSION | 0 … 4.5 | 1 | — |  | game.js, post.js×3 |
| `ssaoRadius` | AO RADIUS | 0.1 … 6.15 | 0.6 | `uRadius` |  | post.js×2 |
| `contactStr` | CONTACT SHADOW | 0 … 4.5 | 1 | — | ✓ | game.js, post.js×4 |
| `ambContactDark` | AMBIENT CONTACT DARK | 0 … 4.5 | 1 | `uAmbContactDark` |  | glx.js×2 |
...
| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `lampLevel` | LAMP LEVEL | 0.02 … 2.25 | 0.26 | — | ✓ | light-store.js, game.js×3 |
| `floodDay` | DAYTIME LAMPS | 0 … 2.25 | 0 | — |  | game.js×4 |
| `poolEnergy` | POOL ENERGY | 0.04 … 3 | 0.55 | — | ✓ | lighting.js×5 |
| `lampRadiusMul` | POOL RADIUS | 0.3 … 4.5 | 1 | — | ✓ | lighting.js×3 |
| `lampDensity` | LAMP DENSITY | 0.5 … 3.75 | 1 | — |  | lighting.js×4, tracks.js×2 |
| `bleedMul` | VALLEY BLEED | 0 … 7.5 | 1 | — | ✓ | lighting.js×3 |
| `glareStr` | LENS GLARE | 0 … 2.25 | 0.12 | — | ✓ | game.js×2 |
| `lampTemp` | LAMP TEMPERATURE | -3 … 3 | 0 | — | ✓ | game.js |
| `lampFlicker` | LAMP FLICKER | 0 … 0.6 | 0.1 | — |  | lighting.js×3 |
| `beamCone` | BEAM CONE WIDTH | 0.4 … 3.3 | 1 | — | ✓ | lighting.js×3 |
| `lampWallSpill` | LAMP WALL SPILL | 0 … 4.5 | 1 | `uLampWallSpill` |  | glx.js×2 |
...
| `twilightRamp` | TWILIGHT RAMP | 2 … 21 | 6 | — |  | game.js×2 |
| `twilightWarm` | TWILIGHT WARMTH | 0 … 4.5 | 1 | — |  | game.js×2 |
...
| `roadChunkLamps` | PER-CHUNK ROAD | 0 … 1 | 0 | — |  | game.js×3 |
| `lampCullFade` | LAMP CULL FADE | 0.1 … 0.9 | 0.35 | — |  | lighting.js×2 |
| `lampGapFill` | DARK-GAP FILL | 0 … 600 | 60 | — |  | lighting.js×2 |
| `lampBehindBias` | BEHIND-CAM BIAS | 1 … 15 | 5.25 | — |  | lighting.js×3 |
| `lampNearClamp` | LAMP NEAR CLAMP | 1 … 18 | 4 | `uLampNearClamp` |  | glx.js×2 |

## NIGHT GLOW & BLOOM  (10)

| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `floodEmitMul` | LIT GEOMETRY | 0 … 4.5 | 1 | — | ✓ | game.js |
| `glowAmp` | EMISSIVE GLOW | 0.2 … 9 | 2.3 | `uGlowAmp` | ✓ | glx.js×2 |
| `neonBoost` | NEON & LENS BLOOM | 0 … 4.5 | 0.6 | `uBloomBoost` |  | glx.js×2 |
| `cityGlowMul` | CITY SKYGLOW | 0 … 7.5 | 1 | — | ✓ | atmosphere.js×2, light-store.js |
| `cityGlowWarm` | SKYGLOW WARMTH | -3 … 3 | 0 | — |  | atmosphere.js |
| `cityGlowTint` | SKYGLOW ON AMBIENT | 0 … 2.25 | 0.28 | — |  | light-store.js, game.js×2 |
| `bloomMul` | BLOOM AMOUNT | 0 … 6 | 1 | — | ✓ | game.js |
| `bloomSpread` | BLOOM SPREAD | 0.3 … 6 | 1 | `uSpread` | ✓ | post.js×2 |
...
| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `fogDensityMul` | FOG DENSITY | 0 … 7.5 | 1 | `uFogDensity` | ✓ | atmosphere.js, glx.js×2 |
| `fogHeight` | FOG HEIGHT FALLOFF | 0 … 0.2 | 0.018 | `uFogHeight` | ✓ | game.js×3, gfx.js, glx.js×4 |
| `fogTint` | FOG WARM / COOL | -3 … 3 | 0 | `uFogTint` | ✓ | glx.js×2 |
| `fogColorSat` | FOG COLOUR SATURATION | 0 … 4.5 | 1 | — |  | atmosphere.js×2, light-store.js |
| `mistDensity` | GROUND MIST | 0 … 6 | 1 | `uGroundMist` | ✓ | game.js×3, glx.js×2 |
| `mistHeight` | MIST HEIGHT BAND | 0.04 … 1.8 | 0.3 | `uMistHeight` | ✓ | glx.js×2 |
| `lampFogBase` | FOG GLOW BASE | 0 … 0.9 | 0.45 | — | ✓ | game.js |
| `lampFogHaze` | FOG GLOW HAZE | 0 … 3.75 | 0.6 | — | ✓ | game.js |
| `mistShare` | MIST GLOW SHARE | 0 … 9 | 1.5 | `uMistShare` |  | glx.js×2 |
| `hazeWetShare` | WET HAZE SHARE | 0 … 2.25 | 0.22 | — |  | game.js×2 |
| `hazeCloudShare` | CLOUD HAZE SHARE | 0 … 2.25 | 0.12 | — |  | game.js×2 |
| `fogClip` | FOG GLOW CLIP | 0 … 3.75 | 0.7 | `uLampFogClip` |  | glx.js×2 |
| `fogSunCore` | FOG SUN CORE | 0 … 4.5 | 0.6 | `uFogSunCore` |  | glx.js×2 |
| `overcastFogMul` | OVERCAST FOG BOOST | 1 … 9 | 1.7 | — |  | atmosphere.js×2 |
| `fogWxMul` | FOG BOOST | 1 … 12 | 3 | — |  | atmosphere.js×2 |
| `lampVolBase` | BEAMS (CLEAR) | 0 … 0.8 | 0.05 | — | ✓ | game.js |
| `lampVolHaze` | BEAMS (HAZE) | 0 … 3.75 | 0.65 | — | ✓ | game.js |
| `lampVolCap` | BEAM CEILING | 0 … 2.25 | 0.7 | — |  | game.js |
| `renderDistMul` | RENDER DISTANCE | 0.5 … 3 | 1 | — |  | game.js×2 |

## ROAD & REFLECTIONS  (10)

| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `ssrWetMul` | WET MIRROR | 0 … 3.75 | 1 | — | ✓ | game.js |
...
| `carGlow` | BODY GLOW | 0 … 7.5 | 1 | — |  | game.js |
| `tailLightMul` | TAIL-LIGHT GLOW | 0 … 7.5 | 1 | — |  | lighting.js |
| `brakeGlowMul` | BRAKE FLARE | 0 … 4.5 | 1 | — |  | lighting.js |
| `tailRange` | TAIL-LIGHT RANGE | 60 … 480 | 160 | — |  | lighting.js×2 |
| `tailFade` | TAIL-LIGHT FADE | 0 … 180 | 0 | — |  | lighting.js×3 |
| `carSunGlint` | PAINT SUN GLINT | 0 … 60 | 12 | `uCarSunGlint` |  | glx.js×2 |
| `carSparkle` | METALLIC SPARKLE | 0 … 9 | 1.6 | `uCarSparkle` |  | glx.js×2 |

## SKY & WEATHER  (35)

| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `cloudCover` | CLOUD COVER | -1.5 … 1.5 | 0 | — | ✓ | atmosphere.js×3, light-store.js |
| `cloudShadowDim` | CLOUD SHADOW DEPTH | 0 … 1 | 0.8 | `uCloudShadowDim` |  | glx.js×2 |
| `cloudSpeed` | CLOUD SPEED | 0 … 12 | 1 | `uCloudSpeed` |  | game.js×4, gfx.js×2, post.js, glx.js×7 |
| `starBright` | STAR BRIGHTNESS | 0 … 6 | 1 | `uStarBright` | ✓ | game.js×2, gfx.js, glx.js×2 |
| `starDensity` | STAR DENSITY | 0.2 … 9 | 1 | `uStarDensity` |  | game.js×2, glx.js×2 |
| `skyGrad` | SKY GRADIENT | 0.15 … 1.8 | 0.35 | `uSkyGrad` |  | game.js×2, glx.js×2 |
| `daySkyBlue` | DAY SKY BLUE | 0 … 3.75 | 1 | `uDaySkyBlue` |  | game.js×2, glx.js×2 |
| `mieScatter` | SKY SUN GLOW | 0 … 6 | 1 | `uMieScatter` |  | game.js×2, glx.js×2 |
| `cloudSilver` | CLOUD SILVER LINING | 0 … 6 | 1 | `uCloudSilver` |  | game.js×2, glx.js×2 |
| `coronaAureole` | SUN AUREOLE | 0 … 6 | 1 | `uCoronaAureole` |  | game.js×2, glx.js×2 |
| `sunDiscSize` | SUN DISC SIZE | 0.3 … 6 | 1 | `uSunDiscSize` |  | game.js×2, glx.js×2 |
| `sunCorona` | SUN CORONA RING | 0 … 6 | 1 | `uSunCorona` |  | game.js×2, glx.js×2 |
| `sunSquash` | SUN HORIZON SQUASH | 0 … 4.5 | 1 | `uSunSquash` |  | game.js×2, glx.js×2 |
| `starSize` | STAR SIZE | 0.2 … 6 | 1 | `uStarSize` |  | game.js×2, glx.js×2 |
| `starTwinkle` | STAR TWINKLE | 0 … 6 | 1 | `uStarTwinkle` |  | game.js×2, glx.js×2 |
| `moonDiscSize` | MOON DISC SIZE | 0.3 … 6 | 1 | `uMoonDiscSize` |  | game.js×2, glx.js×2 |
| `moonHalo` | MOON HALO SPREAD | 0 … 6 | 1 | `uMoonHalo` |  | game.js×2, glx.js×2, sky.js×2 |
| `cityGlowReach` | CITY GLOW REACH | 0.2 … 6 | 1 | `uCityGlowReach` |  | game.js×2, glx.js×2 |
| `cloudDef` | CLOUD DEFINITION | 0 … 3 | 1 | `uCloudDef` |  | game.js×2, glx.js×2 |
| `skyColorSat` | SKY COLOUR SATURATION | 0 … 4.5 | 1 | — |  | atmosphere.js×2, light-store.js |
| `wetness` | WETNESS | -0.05 … 1 | -0.05 | — |  | apex.js×5, particles.js, game.js×16, gfx.js, glx.js×2, lit.js×3, post.js×2 |
| `rainCount` | RAIN INTENSITY | 20 … 2100 | 360 | — | ✓ | light-store.js, particles.js |
| `rainStreak` | RAIN STREAK LEN | 0.2 … 6 | 1 | — |  | light-store.js, particles.js |
| `rainSpeed` | RAIN FALL SPEED | 0.2 … 4.5 | 1 | — |  | light-store.js, particles.js×2 |
| `drizzleCount` | DRIZZLE DENSITY | 0 … 1 | 0.3 | — |  | light-store.js, particles.js×2 |
| `drizzleLen` | DRIZZLE STREAK | 0 … 2.25 | 0.5 | — |  | light-store.js, particles.js×2 |
| `drizzleSpeed` | DRIZZLE FALL SPEED | 0 … 2.25 | 0.6 | — |  | light-store.js, particles.js×2 |
| `rainOpacity` | RAIN OPACITY | 0 … 3 | 1 | — |  | particles.js×2 |
| `rainWind` | RAIN WIND | -3 … 3 | 0.18 | — | ✓ | particles.js |
| `rainShearWind` | RAIN SPEED SLANT | 0 … 4.5 | 0.9 | — |  | particles.js×3 |
| `rainShearLen` | RAIN SPEED STRETCH | 0 … 9 | 2 | — |  | particles.js×3 |
| `lightning` | LIGHTNING FREQ | 0 … 9 | 1 | — | ✓ | apex.js×2, atmosphere.js×5, game.js×9, glx.js×2 |
| `lightningFlash` | LIGHTNING FLASH | 0 … 4.5 | 1 | — |  | game.js×2 |
| `lightningDecay` | LIGHTNING DECAY | 2 … 30 | 8 | — |  | game.js×4 |
| `weatherSunMute` | WEATHER SUN MUTE | 0 … 3 | 1 | — |  | atmosphere.js×2 |

## IMAGE & COLOUR  (41)

| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `exposureMul` | EXPOSURE | 0.1 … 4.5 | 1 | — | ✓ | game.js |
| `contrast` | CONTRAST | 0.5 … 4.5 | 1.12 | `uContrast` | ✓ | car3d.js, liveries.js, liverytex.js×20, catalunya.js, estoril.js, hockenheim.js, indianapolis.js×2, portimao.js, shanghai.js, atmosphere.js×2, lighting.js, perf.js, game.js, qr.js, post.js×2, lit.js×2, post.js×3, sky.js×2, scenery-city.js×2 |
| `blacks` | BLACKS | -1.5 … 1.5 | 0 | — | ✓ | post.js×3, glx.js, post.js×6 |
| `shadows` | SHADOWS | -1.5 … 1.5 | 0 | — | ✓ | spa.js, atmosphere.js×7, game.js×22, gfx.js, post.js×6, shadow.js×3, glx.js×6, chunks.js, lit.js×15, post.js×10, tracks.js |
| `midtones` | MIDTONES | -1.5 … 1.5 | 0 | — | ✓ | post.js×3, post.js |
| `highlights` | HIGHLIGHTS | -1.5 … 1.5 | 0 | — | ✓ | abudhabi.js, game.js×2, post.js×3, chunks.js, lit.js×3, post.js×7 |
| `whites` | WHITES | -1.5 … 1.5 | 0 | — | ✓ | post.js×3, post.js×2 |
| `toe` | TOE | -1.5 … 1.5 | 0 | — | ✓ | car3d.js×2, parts.js×13, audio.js×2, post.js×3, post.js×3 |
| `shoulder` | SHOULDER | -1.5 … 1.5 | 0 | — | ✓ | car3d.js×21, liverytex.js, parts.js×27, abudhabi.js, hungaroring.js×2, jeddah.js×3, mexico.js, monaco.js, portimao.js, redbull.js, cameras.js, game.js, post.js×3, lit.js×2, post.js×4, mesh.js×9, scenery-nature.js×2 |
| `liftR` | LIFT · RED | -0.15 … 0.15 | 0 | — | ✓ | post.js×3 |
| `liftG` | LIFT · GREEN | -0.15 … 0.15 | 0 | — | ✓ | post.js×3 |
| `liftB` | LIFT · BLUE | -0.15 … 0.15 | 0 | — | ✓ | post.js×3 |
| `gammaR` | GAMMA · RED | 0.5 … 3 | 1 | — | ✓ | post.js×4 |
| `gammaG` | GAMMA · GREEN | 0.5 … 3 | 1 | — | ✓ | post.js×4 |
| `gammaB` | GAMMA · BLUE | 0.5 … 3 | 1 | — | ✓ | post.js×4 |
| `gainR` | GAIN · RED | 0.5 … 2.25 | 1 | — | ✓ | post.js×4 |
| `gainG` | GAIN · GREEN | 0.5 … 2.25 | 1 | — | ✓ | post.js×4 |
| `gainB` | GAIN · BLUE | 0.5 … 2.25 | 1 | — | ✓ | post.js×4 |
| `saturation` | SATURATION | 0 … 4.5 | 1 | `uSaturation` | ✓ | singapore.js, bodyattitude.js, game.js, post.js×2, post.js×3 |
| `vibrance` | VIBRANCE | 0 … 2.25 | 0.2 | `uVibrance` | ✓ | post.js×2, chunks.js, post.js |
| `tint` | WARM / COOL | -3 … 3 | 0 | `uTint` | ✓ | car3d.js, liveries.js, liverytex.js×6, cota.js×3, miami.js, monza.js, spa.js, vegas.js×9, zandvoort.js×4, atmosphere.js×3, carmesh.js, lighting.js×16, particles.js×2, quali.js, setup-ui.js, game.js×7, gltf.js×8, post.js×2, fx.js, lit.js×12, post.js×4, sky.js×2, circuit-kit.js×6, geom.js×6, graph.js, maps.js, scenery-city.js×5, scenery-data.js×3, scenery-structures.js, tracks.js×5 |
| `gradeStr` | GRADE STRENGTH | 0 … 6 | 1 | — | ✓ | game.js×2 |
...
| `acesC` | TONE CURVE CONTRAST | 1 … 6 | 2.43 | `uAcesC` |  | post.js×2 |
| `acesD` | TONE CURVE MIDS | 0.1 … 3 | 0.59 | `uAcesD` |  | post.js×2 |
| `acesE` | TONE CURVE BLACK | 0.02 … 0.6 | 0.14 | `uAcesE` |  | post.js×2 |
| `chromAb` | CHROMATIC AB. | 0 … 7.5 | 0 | `uChromAb` |  | post.js×2 |
...
| `flareMul` | LENS FLARE | 0 … 5.25 | 1 | — | ✓ | game.js×2, post.js×2 |
| `flareStreak` | FLARE STREAK | 2 … 45 | 7 | `uFlareStreak` |  | post.js×2 |
| `flareStreak2` | FLARE CORE STREAK | 0 … 4.5 | 0.5 | `uFlareStreak2` |  | post.js×2 |
| `sharpen` | SHARPEN | 0 … 3 | 0 | `uSharpen` |  | post.js×3, post.js |
