# LIGHTING TUNER — the 185 sliders, and what each one drives
...
<!-- GENERATED: tune-defs -->
_Generated by `node tools/gen/gen-slider-doc.mjs` from `TUNE_DEFS` in `js/lighting/knobs.js` — 185 sliders in 11 groups. Do not edit the tables by hand; `--check` guards them (`tests/unit/generated-docs.test.mjs`)._
...
| `godrayAniso` | GOD-RAY FOCUS | 0 … 0.95 | 0.6 | `uHgAniso` | ✓ | — |
| `godrayFloor` | GOD-RAY HAZE | 0 … 0.2 | 0.02 | `uHgFloor` | ✓ | — |
| `godrayLowBoost` | GOD-RAY LOW-SUN DRAMA | 0 … 1.375 | 0.55 | — | ✓ | game.js×2 |
| `godrayBase` | GOD-RAY BASE | 0 … 0.95 | 0.38 | — | ✓ | game.js×2 |
| `sunShaftMul` | SCREEN SUN-SHAFT | 0 … 2.5 | 1 | — | ✓ | — |
| `sunShaftDecay` | SUN-SHAFT REACH | 0.08 … 0.98 | 0.82 | `uShaftDecay` | ✓ | — |
...
| `shadowRange` | SHADOW DISTANCE | 16 … 200 | 80 | `uShadowRange` | ✓ | glx.js×2, shadow-pass.js×2 |
...
| `moonShadow` | MOON SHADOWS | 0 … 1 | 0.25 | — |   | game.js×3, glx.js×2, shadow-pass.js×4 |
| `carShadow` | CAR SUN SHADOWS | 0 … 1 | 1 | — |   | glx.js, shadow-pass.js×2 |
| `lampShadow` | LAMP SHADOWS | 0 … 1 | 1 | — |   | glx.js, shadow-pass.js |
| `aoStr` | AMBIENT OCCLUSION | 0 … 1.05 | 1 | — |   | game.js |
| `ssaoRadius` | AO RADIUS | 0.02 … 1.465 | 0.6 | `uRadius` |   | — |
...
| `lampBake` | BAKED LAMP POOLS | 0 … 1 | 1 | — |   | game.js×4, atmosphere.js, glx.js×2 |
...
| `bloomKnee` | BLOOM ON HIGHLIGHTS | 0 … 1 | 0.5 | `uBloomKnee` | ✓ | — |
...
| `ssrThick` | SSR THICKNESS | 0.05 … 1 | 0.2 | `uSsrThick` | ✓ | — |
...
| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `carReflect` | CAR REFLECTION | 0 … 1 | 0.05 | `uCarReflect` | ✓ | game.js, post.js×6 |
| `carEnvCube` | ENV REFLECTION | 0 … 1 | 0.3 | — | ✓ | game.js, glx.js×2 |
| `carGloss` | PAINT GLOSS | 0.2 … 1.4 | 1 | `uCarGloss` | ✓ | game.js |
...
| `gammaG` | GAMMA · GREEN | 0.4 … 2.5 | 1 | — | ✓ | post-common.js×2 |
| `gammaB` | GAMMA · BLUE | 0.4 … 2.5 | 1 | — | ✓ | post-common.js×2 |
...
| `flareStreak` | FLARE STREAK | 2 … 10 | 7 | `uFlareStreak` | ✓ | — |
| `flareStreak2` | FLARE CORE STREAK | 0 … 1.25 | 0.5 | `uFlareStreak2` | ✓ | — |
| `sharpen` | SHARPEN | 0 … 2.5 | 0 | `uSharpen` | ✓ | — |
...
| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `blacks` | BLACKS | -0.6 … 0.6 | 0 | — | ✓ | post-common.js |

### RGB LIFT / GAMMA / GAIN

| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `liftR` | LIFT · RED | -0.3 … 0.3 | 0 | — | ✓ | post-common.js |

### COLOUR

| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `saturation` | SATURATION | 0 … 2.5 | 1 | `uSaturation` | ✓ | — |

### LENS & FINISH

| id | slider | range | def | uniform | preset | consumed in |
|---|---|---|---|---|---|---|
| `vignette` | VIGNETTE | 0 … 1 | 0.8 | `uVignette` | ✓ | — |
