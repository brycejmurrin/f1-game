...
| `ui-redesign.spec.js` | the redesign foundation in one renderer-light journey: searchable circuits, the Garage's roving tab contract, Settings at 200% on a short landscape phone, compact lighting tuner (one scroller, help off), How to Play wide contents rail, and fixed-layout Last Race columns at phone portrait width |
