...
101 root Playwright spec files (`tests/*.spec.js`) + 38 `node --test` unit suites
...
| `ui-button-touch.spec.js` | button/touch steer mode: auto-throttle, disabled calibrate, race-settings layout |
