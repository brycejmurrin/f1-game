...
| `trim-comments.test.mjs` | smoke `tools/trim-comments.mjs`: `--help`, divider/loc-pointer/block-divider removal, embedded dividers inside // runs, and KEEP-keyword preservation in `--narrative` blocks |
