...
| `mcp-wrap.test.mjs` | official `apex-probes` MCP server (`tools/mcp-wrap.py`) wrapping chrome-devtools + tinyfish — SDK Server, resources/prompts, stdio initialize, `.mcp.json` entry |
