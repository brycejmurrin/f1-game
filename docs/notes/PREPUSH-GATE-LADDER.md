...
| `npm run test:tooling-fast` | 245 of 324 | 79 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 309 of 324 | 15 | the whole gate; what a deploy runs |
