...
| `npm run test:tooling-fast` | 228 of 303 | 75 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 289 of 303 | 14 (`test:sweeps`) | the whole gate; what a deploy runs |
