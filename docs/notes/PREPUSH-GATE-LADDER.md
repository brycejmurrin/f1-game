...
| `npm run test:tooling-fast` | 236 of 315 | 79 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 300 of 315 | 15 | the whole gate; what a deploy runs |
