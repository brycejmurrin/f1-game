...
| `npm run test:tooling-fast` | 257 of 340 | 83 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 323 of 340 | 17 | the whole gate; what a deploy runs |
...
the 83 files it leaves out cost about 7.5 minutes serial on this box
