...
| `npm run test:tooling-fast` | 244 of 323 | 79 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 308 of 323 | 15 | the whole gate; what a deploy runs |
