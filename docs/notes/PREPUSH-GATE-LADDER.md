...
| `npm run test:tooling-fast` | 226 of 300 | 74 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 286 of 300 | 14 (`test:sweeps`) | the whole gate; what a deploy runs |
