...
| `npm run test:tooling-fast` | 230 of 305 | 75 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 291 of 305 | 14 (`test:sweeps`) | the whole gate; what a deploy runs |
