...
| `npm run test:tooling-fast` | 265 of 348 | 83 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 331 of 348 | 17 | the whole gate; what a deploy runs |
