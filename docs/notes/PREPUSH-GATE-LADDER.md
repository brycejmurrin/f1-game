...
| `npm run test:tooling-fast` | 264 of 347 | 83 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 330 of 347 | 17 | the whole gate; what a deploy runs |
