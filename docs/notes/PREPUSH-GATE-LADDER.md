...
| `npm run test:tooling-fast` | 255 of 337 | 82 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 320 of 337 | 17 | the whole gate; what a deploy runs |
