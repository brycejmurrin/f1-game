...
| `npm run test:tooling-fast` | 260 of 342 | 82 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 325 of 342 | 17 | the whole gate; what a deploy runs |
