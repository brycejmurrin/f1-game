...
| `npm run test:tooling-fast` | 247 of 327 | 80 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 312 of 327 | 15 | the whole gate; what a deploy runs |
