...
| `npm run test:tooling-fast` | 253 of 335 | 82 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 318 of 335 | 17 | the whole gate; what a deploy runs |
