...
| `npm run test:tooling-fast` | 251 of 332 | 81 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 316 of 332 | 16 | the whole gate; what a deploy runs |
