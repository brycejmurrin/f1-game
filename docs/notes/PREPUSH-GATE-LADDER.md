...
| `npm run test:tooling-fast` | 229 of 304 | 75 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 290 of 304 | 14 (`test:sweeps`) | the whole gate; what a deploy runs |
