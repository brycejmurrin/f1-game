...
| `npm run test:tooling-fast` | 259 of 341 | 82 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 324 of 341 | 17 | the whole gate; what a deploy runs |
