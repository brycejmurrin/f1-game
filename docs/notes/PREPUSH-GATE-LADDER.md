...
| `npm run test:tooling-fast` | 251 of 333 | 82 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 316 of 333 | 17 | the whole gate; what a deploy runs |
