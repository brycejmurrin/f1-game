...
| `npm run test:tooling-fast` | 227 of 301 | 74 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 287 of 301 | 14 | the whole gate; what a deploy runs |
