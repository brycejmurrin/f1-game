...
| `npm run test:tooling-fast` | 240 of 320 | 80 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 305 of 320 | 15 | the whole gate; what a deploy runs |
...
the 80 files it leaves out cost about 7.5 minutes serial on this box
