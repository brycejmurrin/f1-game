...
| `npm run test:tooling-fast` | 257 of 339 | 82 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 322 of 339 | 17 | the whole gate; what a deploy runs |
