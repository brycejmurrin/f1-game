...
| `npm run test:tooling-fast` | 250 of 331 | 81 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 315 of 331 | 16 | the whole gate; what a deploy runs |
