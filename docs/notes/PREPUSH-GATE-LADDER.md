...
| `npm run test:tooling-fast` | 233 of 308 | 75 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 294 of 308 | 14 (`test:sweeps`) | the whole gate; what a deploy runs |
