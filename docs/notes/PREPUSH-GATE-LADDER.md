...
| `npm run test:tooling-fast` | 234 of 312 | 78 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 297 of 312 | 15 | the whole gate; what a deploy runs |
