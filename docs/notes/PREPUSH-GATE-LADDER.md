...
| `npm run test:tooling-fast` | 235 of 314 | 79 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 299 of 314 | 15 | the whole gate; what a deploy runs |
