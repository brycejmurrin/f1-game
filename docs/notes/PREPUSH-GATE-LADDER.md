...
| `npm run test:tooling-fast` | 233 of 310 | 77 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 295 of 310 | 15 | the whole gate; what a deploy runs |
