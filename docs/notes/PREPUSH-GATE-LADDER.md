...
| `npm run test:tooling-fast` | 249 of 330 | 81 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 314 of 330 | 16 | the whole gate; what a deploy runs |
