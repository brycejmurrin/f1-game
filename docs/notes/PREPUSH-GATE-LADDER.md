...
| `npm run test:tooling-fast` | 234 of 311 | 77 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 296 of 311 | 15 | the whole gate; what a deploy runs |
