...
| `npm run test:tooling-fast` | 248 of 329 | 81 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 313 of 329 | 16 | the whole gate; what a deploy runs |
