...
| `npm run test:tooling-fast` | 243 of 322 | 79 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 307 of 322 | 15 | the whole gate; what a deploy runs |
