...
| `npm run test:tooling-fast` | 254 of 336 | 82 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 319 of 336 | 17 | the whole gate; what a deploy runs |
