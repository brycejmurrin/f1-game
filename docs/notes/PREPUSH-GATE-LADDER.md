...
| `npm run test:tooling-fast` | 251 of 331 | 80 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 316 of 331 | 15 | the whole gate; what a deploy runs |
