...
| `npm run test:tooling-fast` | 232 of 309 | 77 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 294 of 309 | 15 | the whole gate; what a deploy runs |
