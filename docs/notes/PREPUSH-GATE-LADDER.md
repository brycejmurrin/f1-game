...
| `npm run test:tooling-fast` | 252 of 333 | 81 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 317 of 333 | 16 | the whole gate; what a deploy runs |
