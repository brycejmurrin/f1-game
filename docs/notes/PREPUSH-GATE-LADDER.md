...
| `npm run test:tooling-fast` | 223 of 296 | 73 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 282 of 296 | 14 (`test:sweeps`) | the whole gate; what a deploy runs |
