...
| `npm run test:tooling-fast` | 256 of 338 | 82 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 321 of 338 | 17 | the whole gate; what a deploy runs |
