...
| `npm run test:tooling-fast` | 242 of 321 | 79 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 306 of 321 | 15 | the whole gate; what a deploy runs |
