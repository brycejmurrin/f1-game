...
| `npm run test:tooling-fast` | 249 of 329 | 80 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 314 of 329 | 15 | the whole gate; what a deploy runs |
