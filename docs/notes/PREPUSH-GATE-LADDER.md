...
| `npm run test:tooling-fast` | 252 of 332 | 80 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 317 of 332 | 15 | the whole gate; what a deploy runs |
