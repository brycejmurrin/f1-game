...
| `npm run test:tooling-fast` | 224 of 297 | 73 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 283 of 297 | 14 | the whole gate; what a deploy runs |
