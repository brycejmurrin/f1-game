...
| `npm run test:tooling-fast` | 240 of 319 | 79 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 304 of 319 | 15 | the whole gate; what a deploy runs |
