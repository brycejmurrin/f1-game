...
| `npm run test:tooling-fast` | 230 of 306 | 76 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 291 of 306 | 15 | the whole gate; what a deploy runs |
