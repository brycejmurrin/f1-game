...
| `npm run test:tooling-fast` | 250 of 330 | 80 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 315 of 330 | 15 | the whole gate; what a deploy runs |
