...
| `npm run test:tooling-fast` | 246 of 325 | 79 | the documented edit-loop check |
| `node tools/ci/deploy.mjs --gate-only` | 310 of 325 | 15 | the whole gate; what a deploy runs |
