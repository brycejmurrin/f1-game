...
(see `docs/OCCLUSION-PROBE.md` §4) before this file existed, and the bracket is a
...
look choice, verify it with the depth raster in `docs/OCCLUSION-PROBE.md` rather
