...
- Lay it as a run of footprint-guarded aprons rather than one huge patch, and keep the white cross-lines: they are what stop all that blue reading as water from a distance.
