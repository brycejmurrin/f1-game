...
|------|------|----------|-----------------|
| 0.005 | R | near | Main grandstand, 150 m, covered; second concrete stand at 0.955 |
...
| 0.085 | R | far | **Fisht Stadium**: big translucent shell — the largest silhouette on the circuit |
| 0.115 | R | mid | **Olympic flame tower**, with its rectangular reflecting pool (70×90) at its foot |
| 0.150 | R | far | **Bolshoy Ice Dome**: a low silver dome |
| 0.225 | R | far | **Adler Arena**: a long low glass box |
| 0.00–0.30 | both | — | Foliage and lamps suppressed entirely — the park is paving and architecture, nothing wild |
| 0.05–0.30 | both | near | Tall slim park **lighting columns** in a very regular rhythm, the whole plaza section |
...
| — | inland | far | **The Caucasus**: high mountain ridges closing the inland horizon — the reason the Olympics were here |
...
## 6. Modelling notes
- The park section must be architecturally led: big, clean, geometric volumes on open paving, each venue a distinct silhouette (shell / dome / glass box / spire). Do not dress it with trees or crowd banks.
