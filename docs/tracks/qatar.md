...
|--------|------|------|------------------------|
| 0.00 | L | close | Pit building: record-length low white slab + horizontal banding; hospitality villas behind |
| 0.00 | R | close | **Main Grandstand**: long curved/crescent stepped slab, ~22 m, dark seating face |
| 0.00 | both | mid | Floodlight ring: tall cool-white dual-arm masts (~38 m) densified on S/F |
...
- Hero silhouettes: crescent **main grandstand + record pit slab**, plus **T1 VVIP canopy** and white hospitality villas (not mosque/oasis/Aspire).
- Floodlight ring is the defining "Qatar night" motif — densify cool-white masts via `floodMastRing`.
