...
|---|---|
| Z-fighting / shimmer | Only visible in motion. Use the **motion-capture** skill (`tools/motion-capture.mjs`) to record a driven lap headless; a still frame will not show it. |
