# Cleanup & hardening campaign — archived plan of record (2026-08)

> **Archived.** Campaign complete — provenance only. For current testing workflow
> see `docs/TESTING.md`; for architecture direction see
...
| W3 | Bedrock Ph0-1: dependency scanner + global registry, `.d.ts` contracts, `tsc --checkJs` CI, `@ts-check` tranche + ratchet | Planned — [ARCHITECTURE-REDESIGN-2026-08.md](../../research/ARCHITECTURE-REDESIGN-2026-08.md) is the adopted direction |
