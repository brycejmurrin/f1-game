...
| [research/PERF-HUNT-2026-08-18.md](research/PERF-HUNT-2026-08-18.md) | 08-17 board re-walk; union banner at cache 1421. WGX shadow + quad/decal `writeBuffer` rings flushed 2026-08-18. Optional leftover: defer `apex.js` / `agentview*` (PWA memory). |
