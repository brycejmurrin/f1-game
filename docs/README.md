...
| [WEBGPU-PARITY.md](../docs/research/WEBGPU-PARITY.md) | How to close WGX vs GLX: gap inventory, WebGPU API recipes (MSAA resolve, timestamp-query, texture arrays, mip-gen, god-ray), recommended slice order. §5 holds the WGSL rules a mock device cannot enforce. Left with the 2026-09-03 spike-out and back at this path with the 2026-09-04 re-attach. | `js/render/webgpu/*` |
...
| [research/RENDERER-PERF-AUDIT-2026-09-02.md](research/RENDERER-PERF-AUDIT-2026-09-02.md) | Three read-only renderer perf audits (GLX / WGX / TLX), ranked findings with proposed patches; landed items marked. Held at this path through the 2026-09-03 spike-out and the 2026-09-04 re-attach. | `spike/backends/README.md`, `tools/moves/spike-backends.json` |
