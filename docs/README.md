...
| [`research/BUG-HUNT-2026-09-02.md`](research/BUG-HUNT-2026-09-02.md) | Five read-only bug hunts (UI, GLX, WGX+TLX, memory, race-flow): every CONFIRMED row, what the fix batch landed, what was left and why |
