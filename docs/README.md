...
| [research/AUDIT-2026-08-28.md](research/AUDIT-2026-08-28.md) | Whole-tree total-audit at shell 1599: 268 adversarially-verified findings (0 refuted) across 19 lenses, prioritised into Batch A (code, one cache bump) / Batch B (docs, tools, skills) / Feed-the-restructure / Defer. Batch A1-A2-A4 crash-hang-corruption fixes landed 2026-08-28; the rest is the standing queue. |
