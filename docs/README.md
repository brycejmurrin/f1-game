...
| [research/UI-REDESIGN-2026-08.md](research/UI-REDESIGN-2026-08.md) | The menu system reconsidered from scratch, from seven defects measured live at 852x393: why they are three overlapping systems rather than seven bugs, a `--u` length token to replace `zoom`, a seven-rung type scale, four named container steps, and the order the work has to land in. |
