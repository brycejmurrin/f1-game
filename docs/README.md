...
| [research/APEX-TOOLS-MCP.md](research/APEX-TOOLS-MCP.md) | Design / refuses for the `apex-tools` wrap. Agent map (what is wrapped): [AGENT-SURFACE.md](AGENT-SURFACE.md). |
