...
| [research/APEX-TOOLS-MCP.md](research/APEX-TOOLS-MCP.md) | Design / refuses for the `apex-tools` wrap. Agent map: [AGENT-SURFACE.md](AGENT-SURFACE.md). | `tools/mcp/apex-tools-mcp.mjs`, `spike/backends/tools/wgx-shot.mjs` |
...
| [wgx-gallery/](../spike/backends/docs/wgx-gallery/) | WGX reference frames + `wgx-gallery-manifest.json`, read by `spike/backends/tools/wgx-shot.mjs`. **Moved with the spike-out** on 2026-09-03. | `spike/backends/tools/wgx-shot.mjs` |
