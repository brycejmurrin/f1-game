...
| [notes/AGENT-TOOLING-RESEARCH-2026-09-22.md](notes/AGENT-TOOLING-RESEARCH-2026-09-22.md) | Fourth pass, as research: the agent surface (AGENTS.md, skills, subagents, hooks, MCP, CI, branching) checked against the 2026 guidance by nine web-research subagents and four repo reviewers — what already matches, the three branching models for a shared deploy branch, and the ranked gap list (skill/agent frontmatter, deny list, flake policy, mutation pass). |
