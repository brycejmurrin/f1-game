...
| [UI-MAP.md](UI-MAP.md) | The title-to-race navigation web, mode-specific menu flows, and the source-backed inventory of `UiLayers`, Settings pages, major DOM IDs and CSS entrypoints. Garage deep panels, full How to Play contents and pause chrome are marked partial. |
