...
| `title-fx.js` | `TitleFx` | tag | TitleFx: title-screen motion, wash, door layout, board placement and the background drawing, as player settings under SETTINGS › APPEARANCE. |
