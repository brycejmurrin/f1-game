...
## 2r. All four render paths, measured on a real GPU for the first time (2026-09-02)
...
## 2s. The renderer cached the canvas size and never noticed the viewport move (2026-09-02)
