...
tests/*.spec.js                 Playwright specs (96) + tests/*.test.mjs unit suites (32)
...
96 Playwright specs + 32 `node --test` unit suites. Run groups with `npm run test:<group>` (see Key
