...
tests/*.spec.js                 Playwright specs (96) + tests/*.test.mjs unit suites (31)
...
96 Playwright specs + 31 `node --test` unit suites. Run groups with `npm run test:<group>` (see Key
