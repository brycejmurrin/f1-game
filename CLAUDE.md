...
111 Playwright specs plus 53 `node --test` unit suites; the browser half is
...
tests/           111 Playwright specs + 53 `node --test` unit suites (docs/TESTING.md)
...
(js/game/light-store.js). `.claude/skills/bake-lighting` lands a COPY VALUES
export.
