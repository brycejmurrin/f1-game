...
tests/*.spec.js                 Playwright specs (95) + tests/*.test.mjs unit suites (31)
...
95 Playwright specs + 31 `node --test` unit suites. Run groups with `npm run test:<group>` (see Key
