...
tests/*.spec.js                 Playwright specs (93) + tests/*.test.mjs unit suites (28)
...
93 Playwright specs + 28 `node --test` unit suites. Run groups with `npm run test:<group>` (see Key
