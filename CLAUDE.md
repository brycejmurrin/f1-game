...
tests/*.spec.js                 Playwright specs (98) + tests/*.test.mjs unit suites (32)
...
98 Playwright specs + 32 `node --test` unit suites. Run groups with `npm run test:<group>` (see Key
