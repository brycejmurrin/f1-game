 ...
 *
 *   node tools/lighting/lighting-tuner-sweep.mjs --cond=day-dry                 # one condition
 *   node tools/lighting/lighting-tuner-sweep.mjs --cond=night-dry --from=0 --to=40
 *   node tools/lighting/lighting-tuner-sweep.mjs --list                         # conditions + knob count
 *   node tools/lighting/lighting-tuner-sweep.mjs --report                       # read the shards, no browser
 *   node tools/lighting/lighting-tuner-sweep.mjs --cond=day-dry --force         # ignore recorded results
 *
