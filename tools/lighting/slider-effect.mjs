 ...
 * lightState fields SHOULD move. Does NOT wrap tools/lighting/lighting-tuner-sweep.mjs.
 *
 ...
 *
 *   node tools/lighting/slider-effect.mjs
 *   node tools/lighting/slider-effect.mjs --group LAMPS
 *   node tools/lighting/slider-effect.mjs --class apply-only
 *   node tools/lighting/slider-effect.mjs --gate night
 *   node tools/lighting/slider-effect.mjs --risk inert|conditional|reapply|rebuild
 *   node tools/lighting/slider-effect.mjs --tag saturate|chunk-lamps|sparse-pixels
 *   node tools/lighting/slider-effect.mjs --live lampLevel --from 0 --to 0.55
 *   node tools/lighting/slider-effect.mjs --live lampLevel --shots 5
 *   node tools/lighting/slider-effect.mjs --live lampLevel --levels 0,0.13,0.26,0.55,0.687
 *   node tools/lighting/slider-effect.mjs --filter --a a.png --b b.png --out dir
 *   node tools/lighting/slider-effect.mjs --json
 */
...
lightState fields SHOULD move. It does NOT wrap tools/lighting/lighting-tuner-sweep.mjs.
...
Usage:
  ...
  node tools/lighting/slider-effect.mjs --live lampLevel --shots 5
  node tools/lighting/slider-effect.mjs --live lampLevel --levels 0,0.13,0.26,0.55,0.687
  node tools/lighting/slider-effect.mjs --live lampLevel --dry-run
  node tools/lighting/slider-effect.mjs --live --all --dry-run
  node tools/lighting/slider-effect.mjs --live --group LAMPS --dry-run
  node tools/lighting/slider-effect.mjs --filter --a a.png --b b.png --out dir
  node tools/lighting/slider-effect.mjs --json
  node tools/lighting/slider-effect.mjs --help
...
const VIEW_PY = path.join(ROOT, "tools/lighting/slider-effect-view.py");
