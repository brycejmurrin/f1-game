 ...
 *
 * Usage:
 *   node tools/startline-probe.cjs                 # every circuit, as authored
 *   node tools/startline-probe.cjs --calibrate     # score the hand measure first
 *   node tools/startline-probe.cjs --snap          # as authored vs. snapped
 *   node tools/startline-probe.cjs --frac monza=0  # probe explicit candidates
 *   node tools/startline-probe.cjs --json
 */
"use strict";
