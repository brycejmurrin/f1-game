 ...
 * code is wrong.
 *
 *   node tools/road-lut-census.mjs                # a folded sample + monza
 *   node tools/road-lut-census.mjs vegas baku     # named circuits
 *   node tools/road-lut-census.mjs --all          # every shipped circuit
 *   node tools/road-lut-census.mjs --json
 *   NO_SWIN=1 node tools/road-lut-census.mjs --all   # A/B the shader's
