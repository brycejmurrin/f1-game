 ...
 *     tools/mcp/chrome-devtools-mcp.sh run
 ...
 *
 * Usage:
 *   node tools/mcp/mcp-cli.mjs '[{"name":"navigate_page","arguments":{"url":"..."}}]'
 *   node tools/mcp/mcp-cli.mjs '[]'        # handshake + list the 29 tools
 *
...
const WRAPPER = process.env.APEX_MCP_WRAPPER || path.join(ROOT, "tools/mcp/chrome-devtools-mcp.sh");
...
if (argv[0] === "probe") {
  ...
  node tools/mcp/mcp-cli.mjs '[{"name":"navigate_page","arguments":{"url":"..."}}]'
  node tools/mcp/mcp-cli.mjs '[]'                       handshake + list tools
  node tools/mcp/mcp-cli.mjs probe [flags]              the common shape
