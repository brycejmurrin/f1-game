...
Runs a Chromium (SwiftShader) session via tools/mcp/chrome-devtools-mcp.sh, writes
...
Examples:
  python3 tools/mcp/cdmcp-measure.py                  # foreground boot profile
  python3 tools/mcp/cdmcp-measure.py --bg             # detach; returns immediately
  python3 tools/mcp/cdmcp-measure.py ui --url http://127.0.0.1:3462
  python3 tools/mcp/cdmcp-measure.py full --port 3462
  APEX_PORT=3462 python3 tools/mcp/cdmcp-measure.py boot --bg
  node tools/mcp/cdmcp-bg.mjs boot                    # same as --bg (test-bg twin)
...
def spawn_background(argv: list[str]) -> int:
    ...
    print("check:   node tools/mcp/cdmcp-bg.mjs --status")
    print("block:   node tools/mcp/cdmcp-bg.mjs --wait")
    print(
