...
Usage:
  ...
  python3 tools/mcp/cdmcp-lamps-tune.py
  python3 tools/mcp/cdmcp-lamps-tune.py --bg --port 3456
...
# TUNE_DEFS extremes — read from js/lighting/knobs.js, do not invent:
