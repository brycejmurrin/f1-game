...
//
//   node tools/gfx/wgx-shot.mjs --help
//   node tools/gfx/wgx-shot.mjs [trackId] [--lite] [--out DIR] [--cam orbit|eye|park]
//   node tools/gfx/wgx-shot.mjs --gallery [--lite] [--out DIR]
//
...
import { awaitPresentedFrame, presentedCanvasClip } from "../shot/probe-page.mjs";
...
export async function runWgxGallery({ lite = false, outRoot } = {}) {
  ...
  writeFileSync(refPath, JSON.stringify({
    ...manifest,
    note: "PNG output is gitignored under artifacts/; re-run node tools/gfx/wgx-shot.mjs --gallery to regenerate.",
  }, null, 2) + "\n");
