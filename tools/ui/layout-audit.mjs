...
//   node tools/ui/layout-audit.mjs --report
//
//   # Geometry matrix (default) — clip / tap / overflow / starved
//   node tools/ui/layout-audit.mjs
...
//   node tools/ui/layout-audit.mjs --scale=100,130 --circuits=jeddah
//
//   # Fast PNG + DOM gallery (one boot per viewport, resumable, parallel)
//   node tools/ui/layout-audit.mjs --gallery
//   node tools/ui/layout-audit.mjs --gallery --screens=title,garage --jobs=1
//   node tools/ui/layout-audit.mjs --gallery --force
//
//   # One screen
//   node tools/ui/layout-audit.mjs --screen=settings
//   node tools/ui/layout-audit.mjs --screen=garage --viewport=ios-iphone-portrait
//
//   # Title-path recipe (six screens @ play-shape landscape + shots)
//   node tools/ui/layout-audit.mjs --survey
//   npm run ui:survey
//
// Output:
...
if (skipped.length) {
  ...
  console.log(`  a skip is NOT a pass. Re-run those cells alone before believing them:\n` +
    `    node tools/ui/layout-audit.mjs --viewports=${vps} --screens=${scr} --jobs=1` +
