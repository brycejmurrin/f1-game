...
//
//   node tools/car/trace-logo.mjs <teamId ...>        print path data
//   node tools/car/trace-logo.mjs --write             regenerate js/car/crest-paths.js
//   node tools/car/trace-logo.mjs --rev <sha> ...     source commit (default: the
//                                                 last one that had the files)
//   node tools/car/trace-logo.mjs --layers 2 haas     force a layer count
//
...
const SOURCES = {
  ...
  // NOT traced, and each for a measured reason (node tools/car/trace-logo.mjs
...
/* Apex 26 — team crest path data. GENERATED by tools/car/trace-logo.mjs; do not
