 ...
 *
 *   node tools/gen/assets.mjs bake-synthetic [--size N]   generate a pack, no network
 *   node tools/gen/assets.mjs bake-atlas [--preset generated]   slice 4x4 atlases → MAT layers
 *   node tools/gen/assets.mjs search <textures|models|hdris> <query>
 *   node tools/gen/assets.mjs fetch <mat> <source> [--res 1k]   download CC0 source maps
 *   node tools/gen/assets.mjs bake-material <mat> <dir> [--size N]   sources -> layer
 *   node tools/gen/assets.mjs bake-model <id> <file.glb>
 *   node tools/gen/assets.mjs bake-env <track|tod> --sky r,g,b --ground r,g,b
 *   node tools/gen/assets.mjs verify                     licences, hashes, budget
 *   node tools/gen/assets.mjs credits                    regenerate CREDITS.md
 *
...
function bakeOneSize(size, ids) {
  ...
  return {
    ...
    layers: ids.map((mid) => ({
      ...
      source: "procedural:tools/gen/assets.mjs", licence: "Apex26-Procedural",
      author: "Apex 26",
    })),
  };
}
...
//
//   node tools/gen/assets.mjs import-pack <dir> [--size 256]
//
...
function report(m) {
  ...
  if (bytes > BUDGET_BYTES) console.error("  ✗ OVER BUDGET — see tools/gen/assets.mjs BUDGET_BYTES");
}
...
async function bakeSyntheticModels(_args) {
  ...
  for (const id of SYNTH_MODEL_IDS) {
    ...
    m.models[id] = {
      ...
      mat: mesh.matName,
      sizeM: mesh.sizeM,
      source: "procedural:tools/gen/synth-models.mjs",
      licence: "Apex26-Procedural",
      author: "Apex 26",
