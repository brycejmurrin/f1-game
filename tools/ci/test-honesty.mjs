...
//
//   node tools/ci/test-honesty.mjs            # human report, always exit 0
//   node tools/ci/test-honesty.mjs --json     # machine-readable
//   node tools/ci/test-honesty.mjs --strict   # exit 1 when unexplained skips exist
//
