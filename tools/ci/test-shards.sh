...
#
# Usage:
#   tools/ci/test-shards.sh smoke api collision          # npm test:<group> names
#   WORKERS=2 tools/ci/test-shards.sh circuit barriers   # workers per group
#   LOGDIR=artifacts/logs BASEPORT=3470 tools/ci/test-shards.sh smoke parts
#
# Notes:
