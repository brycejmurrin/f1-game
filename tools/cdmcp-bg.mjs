...
function start(argv) {
  ...
  console.log("check:   node tools/cdmcp-bg.mjs --status");
  console.log("block:   node tools/cdmcp-bg.mjs --wait");
  console.log(
...
if (argv.includes("--status")) status();
  ...
  console.error(
    "usage: node tools/cdmcp-bg.mjs <boot|ui|full> [--port N] [--url URL] [--force]\n" +
