...
//
// Usage:
//   node tools/shot/repro-shot.mjs <repro.json> [out.png] [--w 1600] [--h 720]
//
...
if (!src) { console.error("usage: node tools/shot/repro-shot.mjs <repro.json> [out.png]"); process.exit(2); }
