 ...
 *
 * Usage:
 *   node tools/track/startline-snap.cjs            # table for every located circuit
 *   node tools/track/startline-snap.cjs --json     # machine-readable
 *   node tools/track/startline-snap.cjs monza spa  # just these
 */
"use strict";
...
// CLASSICS in tools/track/import-circuit-path.mjs.
const FEATURE = {
...
/* ---------- projection: identical to tools/track/import-circuit-path.mjs ---------- */
