...
//
// Usage:
//   node tools/track/float-audit.cjs <trackId> [--json] [--all-clusters]
//   node tools/track/float-audit.cjs --all [--top N]
//
...
tools/track/clip-audit.cjs is the actionable form (call-site tagging, cross-model
