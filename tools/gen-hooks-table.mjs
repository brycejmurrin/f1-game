 ...
 *
 *   1. every top-level key of `const api = {…}` in js/game/apex.js (methods,
 ...
 *   2. the agent-view surface as `agentHelp()` in js/game/agentview.js
...
export const APEX = "js/game/apex.js";
export const AGENTVIEW = "js/game/agentview.js";
...
export function renderBlock() {
  ...
  const out = [
    "## Hook index",
    "",
    `_Generated by \`node tools/gen-hooks-table.mjs\` from \`const api = {…}\` in \`js/game/apex.js\` (${hooks.length} hooks, ${nAsync} async) and \`agentHelp()\` in \`js/game/agentview.js\`. Signatures are as written in source; the summary is the comment directly above each hook. The sections below this index are the hand-written reference and are required for every hook (\`tests/unit/hooks-documented.test.mjs\`); \`--check\` guards this block (\`tests/unit/generated-docs.test.mjs\`)._`,
    "",
    "| Hook | Summary |",
    "|---|---|",
  ];
