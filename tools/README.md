...
| **cdmcp-cli.py** | Thin stdio JSON-RPC client for chrome-devtools MCP — `list-tools`, `call <name> [json]`, `survey-title`. Use when you need one MCP call from a shell without the heavier session scripts. | mcp-probe |
