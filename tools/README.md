...
| **cdmcp-cli.py** | Thin stdio JSON-RPC client for chrome-devtools MCP — `list-tools`, `call <name> [json]`, `survey-title`, `apex-shot` (free-cam orbit: waits for `Assets.loadModels`, never `snapCam` after `orbit`). | mcp-probe |
