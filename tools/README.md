...
| **layout-audit.mjs** | Every screen crossed with every viewport shape, MEASURED rather than eyeballed — a layout bug here is a bug in a CELL of that matrix, not in a screen. `node tools/layout-audit.mjs`; see docs/LAYOUT-AUDIT.md. |
