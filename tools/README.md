...
| **shot/garage-angles.mjs** | Garage preset shots, ONE Chromium: walks teams/liveries/any livery field, labels frames, sheets, `--against` A/Bs a ref. Own static server; clears dead `DISPLAY` for headless WebGL. | playwright-probe / garage-parts-livery |
