...
// GENERATED from this file by tools/gen-shell.mjs; tests/unit/load-order.test.mjs
...
// one-line edit here plus `node tools/gen-shell.mjs`.
//
...
const FULL = [
  ...
  "js/core/log.js",
  "js/core/mat4.js",
  // GENERATED by tools/gen-shell.mjs: the tagless rosters below (DEFERRED,
