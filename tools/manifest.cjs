...
const HARD_EDGES = [
  ...
  ["js/ui/opt-group.js", "js/game.js"],  // game.js wires the Settings chip rows (OptGroup.wire) at eval time
  ["js/ui/opt-group.js", "js/ui/scale.js"], // UiScale.create wires the RESOLUTION chips
...
// Both opt-in backends. Spiked out to spike/backends/ on 2026-09-03 and
// RE-ATTACHED on 2026-09-04 (docs/notes/SPIKE-BACKENDS-CHECKLIST.md records the
// move; spike/backends/README.md its inverse). Adding a file here means: no
// <script> tag in index.html, and it MUST also be seeded into sw.js's OPTIONAL
// precache set — the service worker discovers everything else by parsing the
// shell's own tags, so a deferred file is invisible to it.
const DEFERRED = {
  webgpu: [
...
const MOVED = {
  ...
  "js/render/webgpu/wgx.js": "js/render/webgpu/wgx.js",
  "js/render/three/tsl-chunks.js": "js/render/three/tsl-chunks.js",
  "js/render/three/tsl-lit.js": "js/render/three/tsl-lit.js",
  "js/render/three/tsl-sky.js": "js/render/three/tsl-sky.js",
  "js/render/three/tsl-fx.js": "js/render/three/tsl-fx.js",
  "js/render/three/tsl-post.js": "js/render/three/tsl-post.js",
  "js/render/three/tlx-shadow.js": "js/render/three/tlx-shadow.js",
  "js/render/three/tlx-chunked.js": "js/render/three/tlx-chunked.js",
  "js/render/three/tlx-post.js": "js/render/three/tlx-post.js",
  "js/render/three/tlx.js": "js/render/three/tlx.js",
  "vendor/three-0.185.1/LICENSE.txt": "vendor/three-0.185.1/LICENSE.txt",
  "vendor/three-0.185.1/PATCHES.md": "vendor/three-0.185.1/PATCHES.md",
  "vendor/three-0.185.1/three.core.min.js": "vendor/three-0.185.1/three.core.min.js",
  "vendor/three-0.185.1/three.tsl.min.js": "vendor/three-0.185.1/three.tsl.min.js",
  "vendor/three-0.185.1/three.webgpu.min.js": "vendor/three-0.185.1/three.webgpu.min.js",
  "vendor/three-0.185.1/addons/tsl/display/BloomNode.js": "vendor/three-0.185.1/addons/tsl/display/BloomNode.js",
  "tools/gfx/wgx-capture.mjs": "tools/gfx/wgx-capture.mjs",
  ...
  "tools/gfx/wgx-vid-repro.mjs": "tools/gfx/wgx-vid-repro.mjs",
  "tools/gfx/tlx-pack-check.cjs": "tools/gfx/tlx-pack-check.cjs",
  "tools/gfx/wgpu-flag-test.mjs": "tools/gfx/wgpu-flag-test.mjs",
  ...
  "tests/unit/renderer-soft-lifecycle.test.mjs": "tests/unit/renderer-soft-lifecycle.test.mjs",
  "tests/unit/road-lut-frame.test.mjs": "tests/unit/road-lut-frame.test.mjs",
  "tests/specs/tlx-probes.spec.js": "tests/specs/tlx-probes.spec.js",
  "docs/research/WEBGPU-PARITY.md": "docs/research/WEBGPU-PARITY.md",
  "docs/research/wgx-gallery-manifest.json": "docs/research/wgx-gallery-manifest.json",
  "docs/research/wgx-gallery/README.md": "docs/research/wgx-gallery/README.md",
  "docs/research/wgx-gallery/bahrain.png": "docs/research/wgx-gallery/bahrain.png",
  "docs/research/wgx-gallery/monaco-eye.png": "docs/research/wgx-gallery/monaco-eye.png",
  "docs/research/wgx-gallery/montreal-eye.png": "docs/research/wgx-gallery/montreal-eye.png",
  "docs/research/wgx-gallery/montreal.png": "docs/research/wgx-gallery/montreal.png",
  "docs/research/wgx-gallery/singapore.png": "docs/research/wgx-gallery/singapore.png",
  "docs/research/wgx-gallery/spa.png": "docs/research/wgx-gallery/spa.png",
  "docs/research/wgx-gallery/vegas.png": "docs/research/wgx-gallery/vegas.png",
  ".claude/skills/webgpu-debug/SKILL.md": ".claude/skills/webgpu-debug/SKILL.md",
  ".claude/skills/webgpu-debug/references/defects.md": ".claude/skills/webgpu-debug/references/defects.md",
  ".cursor/rules/render-wgx.mdc": ".cursor/rules/render-wgx.mdc",
  ".cursor/rules/render-tlx.mdc": ".cursor/rules/render-tlx.mdc",
  "js/render/webgpu/wgsl-chunks.js": "js/render/webgpu/wgsl-chunks.js",
  "js/render/webgpu/wgsl-post.js": "js/render/webgpu/wgsl-post.js",
  "js/render/webgpu/wgsl-fx.js": "js/render/webgpu/wgsl-fx.js",
  "js/render/webgpu/wgx.js": "js/render/webgpu/wgx.js",
